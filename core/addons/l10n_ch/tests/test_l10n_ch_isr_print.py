...
class ISRTest(AccountTestInvoicingCommon):
    ...
    def test_l10n_ch_postals(self):
        def assertBankAccountValid(
            account_number, expected_account_type, expected_postal=None
        ):
        ...
        assertBankAccountValid(
            "CH6309000000250097798", "iban", expected_postal="25-9779-8"
        )
        assertBankAccountValid(
            "GR1601101250000000012300695", "iban", expected_postal=False
        )
