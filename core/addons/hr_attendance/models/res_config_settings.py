...
class ResConfigSettings(models.TransientModel):
    ...
    group_attendance_use_pin = fields.Boolean(
        string="Employee PIN", implied_group="hr_attendance.group_hr_attendance_use_pin"
    )
    hr_attendance_overtime = fields.Boolean(string="Count Extra Hours", readonly=False)
    overtime_start_date = fields.Date(
        string="Extra Hours Starting Date", readonly=False
    )
