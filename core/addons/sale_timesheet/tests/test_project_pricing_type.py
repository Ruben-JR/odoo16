...
class TestProjectPricingType(TestCommonSaleTimesheet):
    def test_pricing_type(self):
        ...
        self.assertFalse(
            project.filtered_domain(project._search_pricing_type("=", "task_rate"))
        )
        self.assertFalse(
            project.filtered_domain(project._search_pricing_type("=", "fixed_rate"))
        )
        self.assertFalse(
            project.filtered_domain(project._search_pricing_type("=", "employee_rate"))
        )
        self.assertTrue(
            project.filtered_domain(project._search_pricing_type("=", False))
        )
        self.assertTrue(
            project.filtered_domain(project._search_pricing_type("!=", "task_rate"))
        )
