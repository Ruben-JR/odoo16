...
class TestReInvoice(TestCommonSaleTimesheet):
    ...
    def test_at_cost(self):
        ...
        self.assertEqual(
            len(self.sale_order.order_line.filtered(lambda sol: sol.is_expense)),
            2,
            "There should be 4 lines on the SO (2 vendor bill lines created)",
        )
        ...
        self.assertEqual(
            sale_order_line2.qty_delivered,
            0,
        ...
        self.assertEqual(
            len(self.sale_order.project_ids),
            1,
    ...
    def test_sales_price(self):
        ...
        self.assertEqual(
            ...
            (self.company_data["product_delivery_sales_price"].list_price, 3.0, 0, 0),
            "Sale line is wrong after confirming vendor invoice",
        )
        self.assertEqual(
            (
            ...
            (self.company_data["product_order_sales_price"].list_price, 3.0, 0, 0),
            "Sale line is wrong after confirming vendor invoice",
        )
        ...
        self.assertEqual(
            ...
            (self.company_data["product_order_sales_price"].list_price, 2.0, 0, 0),
