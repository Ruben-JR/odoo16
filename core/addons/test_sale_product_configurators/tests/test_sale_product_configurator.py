...
class TestProductConfiguratorUi(HttpCase, TestProductConfiguratorCommon):
    ...
    def test_02_product_configurator_advanced(self):
        ...
        self.start_tour(
            "/web", "sale_product_configurator_advanced_tour", login="salesman"
        )
    ...
    def test_03_product_configurator_edition(self):
        self.start_tour(
            "/web", "sale_product_configurator_edition_tour", login="salesman"
        )
    ...
    def test_05_product_configurator_pricelist(self):
        ...
        self.start_tour(
            "/web", "sale_product_configurator_pricelist_tour", login="salesman"
        )
