...
class TestBasicFields(BaseImportCase):
    def get_fields(self, field):
        return self.env["base_import.import"].get_fields_tree(
    ...
    def test_base(self):
        ...
        self.assertEqualFields(
            ...
            make_field(field_type="char", model_name="base_import.tests.models.char"),
        )
    ...
    def test_required(self):
        ...
        self.assertEqualFields(
            ...
            make_field(
                required=True,
                field_type="char",
                model_name="base_import.tests.models.char.required",
            ),
        )
    ...
    def test_readonly_states(self):
        ...
        self.assertEqualFields(
            self.get_fields("char.states"),
            make_field(
                field_type="char", model_name="base_import.tests.models.char.states"
            ),
        )
    ...
    def test_m2o(self):
        ...
        self.assertEqualFields(
            ...
            make_field(
                field_type="many2one",
                comodel_name="base_import.tests.models.m2o.related",
                model_name="base_import.tests.models.m2o",
                fields=[
                    {
                        "id": "value",
                        "name": "id",
    ...
    def test_m2o_required(self):
        ...
        self.assertEqualFields(
            ...
            make_field(
                field_type="many2one",
                required=True,
                comodel_name="base_import.tests.models.m2o.required.related",
                model_name="base_import.tests.models.m2o.required",
                fields=[
                    {
                        "id": "value",
                        "name": "id",
        ...
        self.assertEqualFields(
            ...
            [
                ID_FIELD,
                {
                    ...
                    "fields": [],
                    "type": "char",
                    "model_name": "base_import.tests.models.o2m",
                },
                {
                    "id": "value",
                    "name": "value",
                    ...
                    "required": False,
                    "type": "one2many",
                    "comodel_name": "base_import.tests.models.o2m.child",
                    "fields": [
                        ID_FIELD,
                        {
                            "id": "parent_id",
                            "name": "parent_id",
                            "model_name": "base_import.tests.models.o2m.child",
                            "string": "Parent",
                            "type": "many2one",
                            "comodel_name": "base_import.tests.models.o2m",
                            "required": False,
                            "fields": [
                                {
                                    "id": "parent_id",
...
class TestMatchHeadersSingle(TransactionCase):
    ...
    def test_distant_match(self):
        ...
        match = Import._get_mapping_suggestion(
            header,
            [{"name": "bob", "string": field_string, "type": "char"}],
            ["char"],
            {},
        )
        ...
        self.assertItemsEqual(
            ...
            [
                ID_FIELD,
                {
                    ...
                    "fields": [],
                    "type": "char",
                    "model_name": "base_import.tests.models.preview",
                },
                {
                    "id": "somevalue",
                    "name": "somevalue",
        ...
        import_wizard = self.env["base_import.import"].create(
            {
                "res_model": "res.partner",
                "file": "\n".join(
                    [";".join(partner_values) for partner_values in file_partner_values]
                ),
                "file_type": "text/csv",
            }
        )
        ...
        partners = self.env["res.partner"].search(
            [
                (
                    "id",
                    "not in",
                    [existing_partner["id"] for existing_partner in existing_partners],
                )
            ],
            order="id asc",
        )
