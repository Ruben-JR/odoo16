...
class PortalChatter(mail.PortalChatter):
    ...
    def portal_chatter_init(
        ...
        result = super(PortalChatter, self).portal_chatter_init(
    ...
    def portal_message_fetch(
        self, res_model, res_id, domain=False, limit=False, offset=False, **kw
    ):
        ...
        result = super(PortalChatter, self).portal_message_fetch(
