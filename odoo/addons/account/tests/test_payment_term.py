...
class TestAccountPaymentTerms(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.pay_term_last_day_of_month = cls.env["account.payment.term"].create(
            {
                ...
                "line_ids": [
                    (0, 0, {"value": "balance", "days": 0, "end_month": True}),
                ],
            }
        )
        ...
        cls.pay_term_30_days_end_of_month = cls.env["account.payment.term"].create(
            {
                ...
                "line_ids": [
                    (0, 0, {"value": "balance", "days": 30, "end_month": True}),
                ],
            }
        )
        ...
        cls.pay_term_1_month_end_of_month = cls.env["account.payment.term"].create(
            {
                ...
                "line_ids": [
                    (
                        0,
                        0,
                        {"value": "balance", "months": 1, "days": 0, "end_month": True},
                    ),
                ],
            }
        )

        cls.pay_term_30_days_end_of_month_the_10 = cls.env[
        ...
        cls.pay_term_90_days_end_of_month_the_10 = cls.env[
            "account.payment.term"
        ].create(
            {
        ...
        cls.pay_term_3_months_end_of_month_the_10 = cls.env[
            "account.payment.term"
        ].create(
            {
        ...
        cls.pay_term_1_month_15_days_end_month_45_days = cls.env[
            "account.payment.term"
        ].create(
            {
    ...
    def test_payment_term(self):
        ...
        self.assertPaymentTerm(
            self.pay_term_next_month_on_the_15, "2019-01-01", ["2019-02-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_next_month_on_the_15, "2019-01-15", ["2019-02-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_next_month_on_the_15, "2019-01-31", ["2019-02-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_last_day_of_month, "2019-01-01", ["2019-01-31"]
        )
        self.assertPaymentTerm(
            self.pay_term_last_day_of_month, "2019-01-15", ["2019-01-31"]
        )
        self.assertPaymentTerm(
            self.pay_term_last_day_of_month, "2019-01-31", ["2019-01-31"]
        )
        self.assertPaymentTerm(
            self.pay_term_first_day_next_month, "2019-01-01", ["2019-02-01"]
        )
        self.assertPaymentTerm(
            self.pay_term_first_day_next_month, "2019-01-15", ["2019-02-01"]
        )
        self.assertPaymentTerm(
            self.pay_term_first_day_next_month, "2019-01-31", ["2019-02-01"]
        )
        ...
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month, "2022-01-01", ["2022-01-31"]
        )
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month, "2022-01-15", ["2022-02-28"]
        )
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month, "2022-01-31", ["2022-03-31"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_end_of_month, "2022-01-01", ["2022-02-28"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_end_of_month, "2022-01-15", ["2022-02-28"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_end_of_month, "2022-01-31", ["2022-02-28"]
        )
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month_the_10, "2022-01-01", ["2022-02-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month_the_10, "2022-01-15", ["2022-03-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_30_days_end_of_month_the_10, "2022-01-31", ["2022-04-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_90_days_end_of_month_the_10, "2022-01-01", ["2022-05-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_90_days_end_of_month_the_10, "2022-01-15", ["2022-05-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_90_days_end_of_month_the_10, "2022-01-31", ["2022-06-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_3_months_end_of_month_the_10, "2022-01-01", ["2022-05-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_3_months_end_of_month_the_10, "2022-01-15", ["2022-05-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_3_months_end_of_month_the_10, "2022-01-31", ["2022-05-10"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_15_days_end_month_45_days,
            "2022-01-01",
            ["2022-04-14"],
        )
        self.assertPaymentTerm(
    ...
    def test_payment_term_compute_method(self):
        def assert_payment_term_values(expected_values_list):
            ...
            for values, (company_amount, discount_balance) in zip(
                res, expected_values_list
            ):
