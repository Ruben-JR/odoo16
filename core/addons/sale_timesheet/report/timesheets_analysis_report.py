...
class TimesheetsAnalysisReport(models.Model):
    ...
    timesheet_revenues = fields.Float(
        "Timesheet Revenues",
        readonly=True,
        help="Number of hours spent multiplied by the unit price per hour/day.",
    )
    margin = fields.Float(
        "Margin", readonly=True, help="Timesheets revenues minus the costs"
    )
    billable_time = fields.Float(
        "Billable Hours", readonly=True, help="Number of hours/days linked to a SOL."
    )
