...
class AccountTestInvoicingCommon(TransactionCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        if not chart_template:
            ...
            cls.skipTest(
                cls,
                "Accounting Tests skipped because the user's company has no chart of accounts.",
            )
        ...
        cls.company_data_2 = cls.setup_company_data(
            "company_2_data", chart_template=chart_template
        )
        ...
        user.write(
            {
                "company_ids": [
                    (
                        ...
                        0,
                        (
                            cls.company_data["company"] + cls.company_data_2["company"]
                        ).ids,
                    )
                ],
        ...
        cls.product_b = cls.env["product.product"].create(
            {
                ...
                "supplier_taxes_id": [
                    (6, 0, (cls.tax_purchase_a + cls.tax_purchase_b).ids)
                ],
            }
        )
        ...
        cls.inbound_payment_method_line = bank_journal.inbound_payment_method_line_ids[
            0
        ]
                ...
                "children_tax_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            ...
                            "cash_basis_transition_account_id": cls.safe_copy(
    ...
    def assertInvoiceValues(self, move, expected_lines_values, expected_move_values):
        ...
        self.assertRecordValues(
            sort_lines(move.line_ids.sorted()), expected_lines_values
        )
    ...
    def _turn_node_as_dict_hierarchy(self, node):
        ...
        return {
            ...
            "attrib": attrib_wo_ns,
            "children": [
                self._turn_node_as_dict_hierarchy(child_node)
    ...
    def assertXmlTreeEqual(self, xml_tree, expected_xml_tree):
        ...
        def assertNodeDictEqual(node_dict, expected_node_dict):
            ...
            node_dict_attrib = {
                k: "___ignore___"
                if expected_node_dict["attrib"].get(k) == "___ignore___"
                else v
            ...
            self.assertEqual(
                ...
                "Number of children elements for node %s is different."
                % node_dict["tag"],
            )
