...
class TestFormatLangDate(TransactionCase):
    ...
    def test_01_code_and_format(self):
        ...
        datetime_us_str = misc.format_datetime(
            lang.with_context(lang="en_US").env, datetime_str, tz="Europe/Brussels"
        )
        self.assertNotEqual(
        ...
        self.assertEqual(
            misc.format_time(
                lang.with_context(lang="zh_CN").env, time_part, time_format="ah:m:ss"
            ),
            "\u4e0b\u53484:30:22",
        )
        ...
        self.assertEqual(
            misc.format_time(
                lang.with_context(lang="zh_CN").env, time_part, time_format="ah:mm"
            ),
            "\u4e0b\u53484:30",
        )
