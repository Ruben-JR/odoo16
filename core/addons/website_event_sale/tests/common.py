...
class TestWebsiteEventSaleCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.pricelist_with_discount = create_pricelist(
            currency=cls.env.company.currency_id,
            name="EUR With Discount Included",
            policy="with_discount",
        )
        cls.pricelist_without_discount = create_pricelist(
            currency=cls.env.company.currency_id,
            name="EUR Without Discount Included",
            policy="without_discount",
        )
        cls.ex_pricelist_with_discount = create_pricelist(
            currency=cls.currency_test,
            name="EX With Discount Included",
            policy="with_discount",
        )
