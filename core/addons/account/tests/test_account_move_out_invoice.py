...
class TestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_out_invoice_line_onchange_rounding_price_subtotal_1(self):
        ...
        self.assertTrue(
            decimal_precision,
            "Decimal precision '%s' not found" % decimal_precision_name,
        )
    ...
    def test_out_invoice_post_1(self):
        ...
        with patch.object(
            fields.Date, "today", lambda *args, **kwargs: frozen_today
        ), patch.object(
                    ...
                    "line_ids": [
                        (
                            ...
                            move.line_ids.filtered(
                                lambda line: line.tax_line_id.id
    ...
    def test_out_invoice_reverse_move_tags(self):
        ...
        self.assertRecordValues(
            invoice.line_ids.sorted("tax_line_id"),
            [
                # Product line
                {
                    "tax_line_id": False,
        ...
        self.assertRecordValues(
            refund.line_ids.sorted("tax_line_id"),
            [
                # Product line
                {
                    "tax_line_id": False,
