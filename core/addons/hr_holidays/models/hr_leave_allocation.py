...
class HolidaysAllocation(models.Model):
    ...
    def _compute_leaves(self):
        employee_days_per_allocation = (
            self.holiday_status_id._get_employees_days_per_allocation(
    ...
    def _compute_number_of_hours_display(self):
        for allocation in self:
            allocation.number_of_hours_display = allocation.number_of_days * (
                allocation.holiday_status_id.company_id.resource_calendar_id.hours_per_day
                or HOURS_PER_DAY
            )
    ...
    def action_confirm(self):
        ...
        self.activity_update()
        self.filtered(
            lambda holiday: holiday.validation_type == "no"
    ...
    def action_validate(self):
        ...
        if any(
            holiday.state != "confirm" and holiday.validation_type != "no"
            for holiday in self
        ):
            raise UserError(
