...
class WebsiteSaleVariantController(VariantController):
    ...
    def get_combination_info_website(
        ...
        """
        kw.pop("pricelist_id")
        combination = self.get_combination_info(
            product_template_id,
            product_id,
            combination,
            add_qty,
        ...
        if (
            ...
            carousel_view = request.env["ir.ui.view"]._render_template(
    ...
    def create_product_variant(
        ...
        return super(WebsiteSaleVariantController, self).create_product_variant(
