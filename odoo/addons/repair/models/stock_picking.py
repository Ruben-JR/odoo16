...
class PickingType(models.Model):
    ...
    def _compute_is_repairable(self):
        for picking_type in self:
            if not (
                picking_type.code == "incoming" and picking_type.return_type_of_ids
            ):
...
class Picking(models.Model):
    ...
    nbr_repairs = fields.Integer(
        "Number of repairs linked to this picking", compute="_compute_nbr_repairs"
    )
