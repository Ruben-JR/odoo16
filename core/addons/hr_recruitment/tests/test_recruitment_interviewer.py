...
class TestRecruitmentInterviewer(MailCommon):
    ...
    def test_interviewer_group(self):
        ...
        self.assertFalse(
            interviewer_group.id in self.simple_user.groups_id.ids,
        ...
        self.assertFalse(
            interviewer_group.id in self.manager_user.groups_id.ids,
            "Manager User should not be interviewer",
        )
        applicant.interviewer_ids = self.manager_user.ids
        self.assertFalse(
            interviewer_group.id in self.manager_user.groups_id.ids,
            "Manager User should not be added in Interviewer group",
        )
    ...
    def test_interviewer_chatter(self):
        ...
        with self.mock_mail_gateway():
            message = applicant.message_post(
                body="A super secret message",
        ...
        try:
            ...
            raise AssertionError(
                "No mail.mail should be sent to members of Interviewer group"
            )
