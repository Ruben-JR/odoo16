...
class TestKitPicking(common.TestMrpCommon):
    ...
    def setUpClass(cls):
        ...
        BomLine.create(
            {"product_id": kit_1.id, "product_qty": 2.0, "bom_id": bom_kit_2.id}
        )
        ...
        BomLine.create(
            {"product_id": kit_2.id, "product_qty": 2.0, "bom_id": bom_kit_parent.id}
        )
        ...
        BomLine.create(
            {"product_id": kit_3.id, "product_qty": 1.0, "bom_id": bom_kit_parent.id}
        )
