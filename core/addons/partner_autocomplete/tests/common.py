...
class MockIAPPartnerAutocomplete(common.BaseCase):
    ...
    def mockPartnerAutocomplete(self, default_data=None, sim_error=None):
            ...
            sim_result = {
                ...
                "child_ids": [
                    ...
                    },
                    {
                        "is_company": False,
                        "type": "contact",
                        "email": "heinrich.clien@test.example.com",
                        "name": "Heinrich Client Support",
                        "street": "Rue des Bourlottes, 9",
                        "phone": "0456 00 11 22",
                        "zip": "1367",
                        "country_code": self.base_be.code,
                        "country_name": self.base_be.name,
                        "state_code": self.be_state_bw.code,
                        "state_name": self.be_state_bw.name,
                    },
                ],
            }
            if default_data:
        ...
        try:
            with patch.object(
                IapAutocompleteEnrichAPI, "_contact_iap", side_effect=_contact_iap
            ):
                yield
        finally:
            pass
