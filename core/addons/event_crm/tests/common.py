...
class EventCrmCase(TestCrmCommon, EventCase):
    ...
    def assertLeadConvertion(self, rule, registrations, partner=None, **expected):
        ...
        self.assertEqual(
            lead.email_from,
            partner.email if partner else registrations._find_first_notnull("email"),
        )
        self.assertEqual(
            lead.phone,
            partner.phone if partner else registrations._find_first_notnull("phone"),
        )
        self.assertEqual(
            lead.mobile,
            partner.mobile
            if partner and partner.mobile
            else registrations._find_first_notnull("mobile"),
        )
