            ...
            "account.move",
            {
                f"{cid}_demo_invoice_1": {
                    ...
                    "invoice_line_ids": [
                        Command.create(
                            {
                                "product_id": ref("product.consu_delivery_02").id,
                                "quantity": 5,
                            }
                        ),
                        Command.create(
                ...
                f"{cid}_demo_invoice_2": {
                    ...
                    "invoice_line_ids": [
                        ...
                        Command.create(
                            {
                                "product_id": ref("product.consu_delivery_01").id,
                                "quantity": 20,
                            }
                        ),
                    ],
                ...
                f"{cid}_demo_invoice_5": {
                    ...
                    "invoice_line_ids": [
                        ...
                        Command.create(
                            {
                                "product_id": ref("product.product_order_01").id,
                                "price_unit": 4.0,
                                "quantity": 5,
                            }
                        ),
    ...
    def _get_demo_account(self, xml_id, account_type, company):
        ...
        return (
            ...
            or self.env["account.account"].search(
                [("account_type", "=", account_type), ("company_id", "=", company.id)],
                limit=1,
            )
            or self.env["account.account"].search(
