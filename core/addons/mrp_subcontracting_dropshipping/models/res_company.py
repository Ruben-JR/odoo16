...
class ResCompany(models.Model):
    ...
    def _create_missing_subcontracting_dropshipping_picking_type(self):
        company_ids = self.env["res.company"].search([])
        company_has_dropship_subcontractor_picking_type = (
            ...
            .search(
                [
                    ...
                    (
                        ...
                        "in",
                        company_ids.subcontracting_location_id.ids,
                    ),
                ]
            )
            .mapped("company_id")
        )
        company_todo_picking_type = (
            company_ids - company_has_dropship_subcontractor_picking_type
        )
