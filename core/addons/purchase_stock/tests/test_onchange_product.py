...
class TestOnchangeProductId(TransactionCase):
    ...
    def test_onchange_product_id(self):
        ...
        po_line.write(
            {"product_qty": 3, "product_uom": self.ref("uom.product_uom_dozen")}
        )
        self.assertEqual(
        ...
        self.assertEqual(
            100,
            po_line2.price_unit,
            "No vendor supplies this product, hence unit price should be set to 100",
        )
        ...
        self.assertEqual(
            1000,
            po_line2.price_unit,
            "The product_uom is multiplied by 10, hence unit price should be set to 1000",
        )
