...
class ResPartner(models.Model):
    ...
    l10n_ar_special_purchase_document_type_ids = fields.Many2many(
        ...
        help="Set here if this partner can issue other documents further than"
    ...
    def _compute_l10n_ar_vat(self):
        ...
        recs_ar_vat = self.filtered(
            lambda x: x.l10n_latam_identification_type_id.l10n_ar_afip_code == "80"
            and x.vat
        )
        for rec in recs_ar_vat:
    ...
    def check_vat(self):
        ...
        l10n_ar_partners = self.filtered(
            lambda x: x.l10n_latam_identification_type_id.l10n_ar_afip_code
        )
