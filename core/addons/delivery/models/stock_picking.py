...
class StockQuantPackage(models.Model):
    ...
    shipping_weight = fields.Float(
        string="Shipping Weight", help="Total weight of the package."
    )
...
class StockPicking(models.Model):
    ...
    def _compute_packages(self):
        for package in self:
            ...
            if self.env["stock.move.line"].search_count(
                [("picking_id", "=", package.id), ("result_package_id", "!=", False)]
            ):
    ...
    def _compute_bulk_weight(self):
        ...
        products_by_id = {
            ...
            for product_res in self.env["product.product"]
            .with_context(active_test=False)
            .search_read(
                [("id", "in", list(set(grp["product_id"][0] for grp in res_groups)))],
                ["uom_id", "weight"],
            )
        }
        for res_group in res_groups:
    ...
    def send_to_shipper(self):
        ...
        if (
            ...
            and self.sale_id
            and self.sale_id._compute_amount_total_without_delivery()
                ...
                delivery_line[0].write(
                    {
                        ...
                        "name": self.carrier_id.with_context(
...
class StockReturnPicking(models.TransientModel):
    ...
    def _create_returns(self):
        ...
        picking.write({"carrier_id": False, "carrier_price": 0.0})
