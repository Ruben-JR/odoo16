...
class TestPurchaseRequisition(TestPurchaseRequisitionCommon):
    ...
    def test_07_alternative_purchases_wizards(self):
        ...
        self.assertEqual(
            orig_po.order_line[0].product_id,
            alt_po_1.order_line[0].product_id,
            "Alternative PO should have copied the product to purchase from original PO",
        )
        self.assertEqual(
            orig_po.order_line[0].product_qty,
            alt_po_1.order_line[0].product_qty,
            "Alternative PO should have copied the qty to purchase from original PO",
        )
        self.assertEqual(
            orig_po.order_line[0].product_uom,
            alt_po_1.order_line[0].product_uom,
        ...
        self.assertEqual(
            warning_wiz.alternative_po_count,
            1,
        ...
        self.assertEqual(
            orig_po.state, "purchase", "Original PO should have been confirmed"
        )
    ...
    def test_09_alternative_po_line_price_unit(self):
        ...
        self.assertEqual(
            po_1.order_line.product_uom_qty,
            0,
            "Line's quantity from the original PO should be reset to 0",
        )
        self.assertEqual(
            po_1.order_line.price_unit,
            16,
