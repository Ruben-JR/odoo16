...
class TestHttp(http.Controller):
    ...
    # =====================================================
    @http.route(
        ["/test_http/greeting", "/test_http/greeting-none"], type="http", auth="none"
    )
    ...
    @http.route(
        "/test_http/echo-json", type="json", auth="none", methods=["POST"], csrf=False
    )
    ...
    @http.route(
        "/test_http/upload_file", methods=["POST"], type="http", auth="none", csrf=False
    )
