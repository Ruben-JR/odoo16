...
class MailGroup(models.Model):
    ...
    moderation_rule_count = fields.Integer(
        string="Moderated emails count", compute="_compute_moderation_rule_count"
    )
    ...
    def _alias_get_error_message(self, message, message_dict, alias):
        ...
        return super(MailGroup, self)._alias_get_error_message(
            message, message_dict, alias
        )
    ...
    def _notify_members(self, message):
        ...
        for batch_email_member in tools.split_every(batch_size, member_emails.items()):
            ...
            for email_member_normalized, email_member in batch_email_member:
                ...
                member_body = tools.append_content_to_html(
                    body, footer, plaintext=False
                )
