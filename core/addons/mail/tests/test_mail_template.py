...
class TestMailTemplateReset(MailCommon):
    ...
    def test_mail_template_reset_translation(self):
        ...
        self.assertEqual(
            mail_template.with_context(lang="en_UK").body_html.strip(),
        ...
        self.assertEqual(mail_template.name, "Mail: Test Mail Template")
        self.assertEqual(
            mail_template.with_context(lang="en_UK").name, "Mail: Test Mail Template"
        )
        self.assertEqual(
