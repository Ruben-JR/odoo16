...
class TestO2M(TransactionCase):
    def test_basic_alterations(self):
        ...
        with Form(r, view="test_testing_utilities.o2m_parent") as f, f.subs.edit(
            index=0
        ) as sub, self.assertRaises(AssertionError):
            sub.name = "whop whop"
    ...
    def test_o2m_editable_list(self):
        ...
        self.assertEqual(
            [
                el.get("name")
                for el in f._view["tree"].xpath('//field[@name="subs"]/tree//field')
            ],
            [
                el.get("name")
        ...
        self.assertIs(
            ...
            f._view["tree"].xpath('//field[@name="subs"]/tree')[0],
    ...
    def test_o2m_remove(self):
        ...
        with Form(r) as f:
            ...
            f.count = 1
            self.assertEqual(
                commands(), [0, 2, 2], "should contain 1 '0' command and 2 deletions"
            )
    ...
    def test_o2m_onchange_change_saved(self):
        ...
        self.assertEqual(
            r.line_ids[0].v, 5, "onchange should have updated the existing lines"
        )
