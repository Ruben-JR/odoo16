...
class SmsApi(models.AbstractModel):
    ...
    def _contact_iap(self, local_endpoint, params):
        ...
        endpoint = (
            ...
            .sudo()
            .get_param("sms.endpoint", DEFAULT_ENDPOINT)
        )
    ...
    def _get_sms_api_error_messages(self):
        ...
        buy_credits_url = (
            self.sudo().env["iap.account"].get_credits_url(service_name="sms")
        )
        ...
        return {
            ...
            "insufficient_credit": " ".join(
                [_("You don't have enough credits on your IAP account."), buy_credits]
            ),
