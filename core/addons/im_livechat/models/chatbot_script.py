...
class ChatbotScript(models.Model):
    ...
    def _compute_livechat_channel_count(self):
        ...
        mapped_channels = {
            channel["chatbot_script_id"][0]: channel["channel_id"]
    ...
    def copy(self, default=None):
        ...
        answers_map = {
            ...
            for clone_answer, original_answer in zip(
                clone_chatbot_script.script_step_ids.answer_ids,
                self.script_step_ids.answer_ids,
            )
        }

        for clone_step, original_step in zip(
            clone_chatbot_script.script_step_ids, self.script_step_ids
        ):
            clone_step.write(
                {
    ...
    def _format_for_frontend(self):
        ...
        return {
            ...
            "chatbot_welcome_steps": [
                step._format_for_frontend() for step in self._get_welcome_steps()
            ],
        }
