...
class TestPickShip(TestStockCommon):
    ...
    def test_unreserve_only_required_quantity(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            product_unreserve, stock_location, 4.0
        )
        quants = self.env["stock.quant"]._gather(
            product_unreserve, stock_location, strict=True
        )
    ...
    def test_mto_moves(self):
        ...
        self.assertEqual(
            backorder.state, "waiting", "Backorder should be waiting for reservation"
        )
    ...
    def test_mto_moves_transfer(self):
        ...
        stock_location = self.env["stock.location"].browse(self.stock_location)
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 10.0
        )
        pack_location = self.env["stock.location"].browse(self.pack_location)
        self.env["stock.quant"]._update_available_quantity(
            self.productA, pack_location, 5.0
        )

        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.productA, stock_location)), 1.0
        )
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.productA, pack_location)), 1.0
        )
        ...
        self.assertEqual(
            sum(
                ...
                ._gather(self.productA, stock_location)
                .mapped("quantity")
            ),
            0.0,
        )
    ...
    def test_mto_moves_extra_qty(self):
        ...
        self.assertEqual(
            move_ids.mapped("procure_method"), ["make_to_order", "make_to_stock"]
        )
    ...
    def test_mto_resupply_cancel_ship(self):
        ...
        warehouse_1.write({"resupply_wh_ids": [(6, 0, [warehouse_2.id])]})
    ...
    def test_edit_done_chained_move(self):
        ...
        self.assertEqual(
            picking_pick.move_ids.quantity_done,
            10.0,
            "Wrong quantity_done for pick move",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            picking_client.move_ids.reserved_availability,
            10.0,
    ...
    def test_chained_move_with_uom(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.gB, pack_location), 0.0
        )
        picking_pick.action_assign()
        picking_pick.move_ids[0].move_line_ids[0].qty_done = 5.0
        picking_pick._action_done()
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.gB, location), 5000.0
        )
        self.assertEqual(
            self.env["stock.quant"]._gather(self.gB, pack_location).quantity, 5000.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.gB, pack_location), 0.0
        )
    ...
    def test_pick_ship_return(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 10.0, lot_id=lot
        )
        ...
        customer_quantity = self.env["stock.quant"]._get_available_quantity(
            self.productA, customer_location, lot_id=lot
        )
        ...
        pack_quantity = self.env["stock.quant"]._get_available_quantity(
            self.productA, pack_location, lot_id=lot
        )
        self.assertEqual(
            pack_quantity,
            0,
        ...
        stock_quantity = self.env["stock.quant"]._get_available_quantity(
            self.productA, stock_location, lot_id=lot
        )
    ...
    def test_pick_pack_ship_return(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 1.0, lot_id=lot
        )
        ...
        stock_return_picking_form = Form(
            self.env["stock.return.picking"].with_context(
                active_ids=picking_pack.ids,
                active_id=picking_pack.ids[0],
                active_model="stock.picking",
            )
        )
        stock_return_picking = stock_return_picking_form.save()
        stock_return_picking.product_return_moves.quantity = 1.0
        stock_return_picking_action = stock_return_picking.create_returns()
        return_pack_picking = self.env["stock.picking"].browse(
            stock_return_picking_action["res_id"]
        )
        ...
        self.assertEqual(
            set(picking_pick.move_ids.move_dest_ids.ids),
            set((picking_pack.move_ids | return_pick_picking.move_ids).ids),
        )
        ...
        self.assertEqual(
            set(picking_pack.move_ids.move_dest_ids.ids),
            set((picking_ship.move_ids | return_pack_picking.move_ids).ids),
        )
        ...
        self.assertEqual(
            set(return_ship_picking.move_ids.move_dest_ids.ids),
            set(return_pack_picking.move_ids.ids),
        )

        self.assertEqual(
            set(return_pack_picking.move_ids.move_orig_ids.ids),
            set((picking_pack.move_ids | return_ship_picking.move_ids).ids),
        )
        self.assertEqual(
            set(return_pack_picking.move_ids.move_dest_ids.ids),
            set(return_pick_picking.move_ids.ids),
        )

        self.assertEqual(
            set(return_pick_picking.move_ids.move_orig_ids.ids),
            set((picking_pick.move_ids | return_pack_picking.move_ids).ids),
        )
    ...
    def test_mto_cancel_move_line(self):
        ...
        self.assertEqual(
            picking_client.move_line_ids.reserved_uom_qty,
            5,
    ...
    def test_return_location(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.productA, pick_location, 10.0
        )
        picking_pick, picking_client = self.create_pick_ship()
    ...
    def test_return_lot(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 7.0, lot_id=lot1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 7.0, lot_id=lot2
        )
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 7.0, lot_id=lot3
        )
        ...
        self.assertEqual(
            ...
            picking_client.location_id.warehouse_id.return_type_id,
        )
...
class TestSinglePicking(TestStockCommon):
    ...
    def test_assign_deadline(self):
        ...
        self.assertEqual(
            move1.reserved_availability,
            2,
            "Earlier deadline should have reserved quantity",
        )
        self.assertEqual(
            move2.reserved_availability,
            0,
            "Later deadline should not have reserved quantity",
        )
        ...
        self.assertEqual(
            move2.reserved_availability, 1, "Move with deadline should take priority"
        )
        self.assertEqual(
            move3.reserved_availability,
            0,
            "Move without deadline should not have reserved quantity",
        )
        self.assertEqual(
            move4.reserved_availability,
            0,
            "Move without deadline should not have reserved quantity",
        )
        ...
        self.assertEqual(
            move2.reserved_availability, 4, "Move with deadline should take priority"
        )
        self.assertEqual(
            move3.reserved_availability,
            0,
        ...
        self.assertEqual(
            move4.reserved_availability,
            1,
            "Earlier move without deadline should take the priority",
        )
    ...
    def test_extra_move_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.productA, pack_location, allow_negative=True
            ),
            -1.0,
        )
        ...
        self.assertEqual(
            move1.move_line_ids.reserved_qty, 0.0
    ...
    def test_extra_move_4(self):
        ...
        stock_location = self.env["stock.location"].browse(self.stock_location)
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 5
        )
        ...
        for move in delivery.move_ids:
            self.assertEqual(
                ...
                "Initial demand should be equals to quantity done",
            )
    ...
    def test_extra_move_5(self):
        ...
        self.assertEqual(
            ...
            5.95,
            "Move initial demand should be 5.95",
        )
    ...
    def test_recheck_availability_1(self):
        ...
        """
        self.env["stock.quant"]._update_available_quantity(
            self.productA, self.env["stock.location"].browse(self.stock_location), 1.0
        )
        delivery_order = self.env["stock.picking"].create(
            {
                "location_id": self.stock_location,
    ...
    def test_recheck_availability_2(self):
        ...
        stock_location = self.env["stock.location"].browse(self.stock_location)
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 1.0, lot_id=lot1
        )
        delivery_order = self.env["stock.picking"].create(
            {
                "location_id": self.stock_location,
    ...
    def test_recheck_availability_4(self):
        ...
        stock_location = self.env["stock.location"].browse(self.stock_location)
        self.env["stock.quant"]._update_available_quantity(
            self.productA, stock_location, 1.0, lot_id=serial1
        )
        delivery_order = self.env["stock.picking"].create(
            {
                "location_id": self.stock_location,
    ...
    def test_use_create_lot_use_existing_lot_1(self):
        ...
        """
        self.env["stock.picking.type"].browse(self.picking_type_out).write(
            {
    ...
    def test_merge_chained_moves_multi_confirm(self):
        ...
        self.assertTrue(
            ...
            "No move created from push rules",
        )
        self.assertEqual(
    ...
    def test_additional_move_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]
            ._gather(self.productB, stock_location)
            .reserved_quantity,
            10.0,
        )
    ...
    def test_owner_1(self):
        ...
        supplier_quant = self.env["stock.quant"]._gather(
            self.productA, supplier_location
        )
...
class TestStockUOM(TestStockCommon):
    ...
    def test_move_product_with_different_uom(self):
        ...
        stock_location = self.env["stock.location"].browse(self.stock_location)
        self.env["stock.quant"]._update_available_quantity(
            product_G, stock_location, 149.88
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            -1,
            "We do not reserve more (in the same UOM) than the quantity in stock",
        )
        # check that we reserve the same quantity in the ml and the quant
        self.assertTrue(
            float_is_zero(
                move_line.reserved_qty - quant.reserved_quantity,
                precision_digits=precision_digits,
            )
        )
    ...
    def test_update_product_move_line_with_different_uom(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            product_LtDA, stock_location, 149
        )
        # quantity in hand converted to kg is more precise than the DA
        self.env["stock.quant"]._update_available_quantity(
            product_GtDA, stock_location, 149.88
        )

        self.assertEqual(
            len(product_LtDA.stock_quant_ids),
            1,
            "One quant should exist for the product.",
        )
        self.assertEqual(
            len(product_GtDA.stock_quant_ids),
            1,
            "One quant should exist for the product.",
        )
        ...
        self.env["stock.quant"]._update_available_quantity(
            product_LtDA, stock_location, 149.88
        )
        self.env["stock.quant"]._update_available_quantity(
            product_GtDA, stock_location, 149.88
        )
        ...
        self.assertTrue(
            float_is_zero(
                reserved_on_move_lines_LtDA - quant_LtDA.reserved_quantity,
                precision_digits=precision_digits,
            )
        )
        self.assertTrue(
            float_is_zero(
                reserved_on_move_lines_GtDA - quant_GtDA.reserved_quantity,
                precision_digits=precision_digits,
            )
        )
...
class TestRoutes(TestStockCommon):
    ...
    def _enable_pick_ship(self):
        ...
        self.pick_ship_route = self.wh.route_ids.filtered(
    ...
    def test_pick_ship_1(self):
        ...
        pick_rule = self.pick_ship_route.rule_ids.filtered(
        ...
        procurement_group2 = self.env["procurement.group"].create(
    ...
    def test_replenish_pick_ship_1(self):
        ...
        last_picking_id = self.env["stock.picking"].search(
    ...
    def test_mtso_mto(self):
        ...
        qty_available = self.env["stock.quant"]._get_available_quantity(
            product_a, warehouse.wh_output_stock_loc_id
        )
        ...
        for picking in picking_ids:
            ...
            self.assertEqual(
                ...
                5,
                "The quantity of the move should be the same as on the SO",
            )
        ...
        self.env["procurement.group"].run(
            [
                pg1.Procurement(
                    ...
                    "test_mtso_mts_1",
                    warehouse.company_id,
                    {"warehouse_id": warehouse, "group_id": pg1},
                ),
                pg2.Procurement(
                    product_a,
                    2.0,
                    ...
                    "test_mtso_mts_2",
                    warehouse.company_id,
                    {"warehouse_id": warehouse, "group_id": pg2},
                ),
                pg3.Procurement(
                    product_a,
                    2.0,
                    ...
                    "test_mtso_mts_3",
                    warehouse.company_id,
                    {"warehouse_id": warehouse, "group_id": pg3},
                ),
            ]
        )
    ...
    def test_mtso_mto_adjust_01(self):
        ...
        self.assertEqual(
            move_B.procure_method, "make_to_stock", 'Move A should be "make_to_order"'
        )
        ...
        self.assertEqual(
            move_B.procure_method, "make_to_order", 'Move A should be "make_to_order"'
        )
    ...
    def test_mtso_mto_adjust_02(self):
        ...
        self.assertEqual(
            move_A1.procure_method, "make_to_stock", 'Move A1 should be "make_to_stock"'
        )
        self.assertEqual(
            move_A2.procure_method, "make_to_stock", 'Move A2 should be "make_to_stock"'
        )
        self.assertEqual(
            move_B1.procure_method, "make_to_stock", 'Move B1 should be "make_to_stock"'
        )
        self.assertEqual(
            move_B2.procure_method, "make_to_stock", 'Move B2 should be "make_to_stock"'
        )
        moves._adjust_procure_method()
        self.assertEqual(
            move_A1.procure_method, "make_to_stock", 'Move A1 should be "make_to_stock"'
        ...
        self.assertEqual(
            move_B2.procure_method, "make_to_order", 'Move B2 should be "make_to_order"'
        )
    ...
    def test_mtso_mto_adjust_03(self):
        ...
        moves._adjust_procure_method()
        self.assertEqual(
            move_A1.procure_method, "make_to_order", 'Move A should be "make_to_stock"'
        )
        self.assertEqual(
            move_A2.procure_method, "make_to_stock", 'Move A should be "make_to_order"'
        )
...
class TestAutoAssign(TestStockCommon):
    ...
    def test_auto_assign_reservation_method(self):
        ...
        self.assertEqual(
            customer_picking1.move_ids.reserved_availability,
            0,
            "There should be no products available to reserve yet.",
        )
        self.assertEqual(
            customer_picking2.move_ids.reserved_availability,
            0,
            "There should be no products available to reserve yet.",
        )
        self.assertEqual(
            customer_picking3.move_ids.reserved_availability,
            0,
            "There should be no products available to reserve yet.",
        )

        self.assertFalse(
            customer_picking1.move_ids.reservation_date,
            "Reservation Method: 'manual' shouldn't have a reservation_date",
        )
        self.assertEqual(
            customer_picking2.move_ids.reservation_date,
        ...
        self.assertFalse(
            customer_picking5.move_ids.reservation_date,
        ...
        self.assertEqual(
            customer_picking4.move_ids.reserved_availability,
            10,
            "Reservation Method: 'by_date' should auto-assign when within reservation date range at confirmation",
        )
        self.assertEqual(
            customer_picking5.move_ids.reserved_availability,
            10,
