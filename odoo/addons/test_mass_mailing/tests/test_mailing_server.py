...
class TestMassMailingServer(TestMassMailCommon):
    ...
    def test_mass_mailing_server_batch(self):
        ...
        self.assertEqual(
            ...
            2,
            "Must be called only once per mail from",
        )
    ...
    def test_mass_mailing_server_default(self):
        ...
        self.assertEqual(
            self.find_mail_server_mocked.call_count, 1, "Must be called only once"
        )
    ...
    def test_mass_mailing_server_forced(self):
        ...
        self.assertEqual(
            self.find_mail_server_mocked.call_count,
            1,
            "Must not be called when mail server is forced",
        )
