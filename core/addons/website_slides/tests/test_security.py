...
class TestAccessFeatures(common.SlidesCase):
    ...
    def test_resource_access(self):
        ...
        self.assertTrue(
            self.slide_3.with_user(self.user_public)._has_additional_resources()
        )
        self.assertTrue(
            self.slide_3.with_user(self.user_public)._has_additional_resources("file")
        )
        self.assertTrue(
            self.slide_3.with_user(self.user_public)._has_additional_resources("url")
        )
