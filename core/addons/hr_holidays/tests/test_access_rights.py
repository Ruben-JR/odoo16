    ...
    def test_draft_status(self):
        ...
        for i, status in enumerate(self.draft_status):
            ...
            leave = self.request_leave(
                1, datetime.today() + relativedelta(days=5 + i), 1, values
            )
            leave.action_draft()
            ...
            leave = self.request_leave(
                1, datetime.today() + relativedelta(days=20 + i), 1, values
            )
...
class TestAccessRightsCreate(TestHrHolidaysAccessRightsCommon):
    ...
    def test_base_user_create_self(self):
        ...
        self.request_leave(
            self.user_employee_id, datetime.today() + relativedelta(days=5), 1, values
        )
    ...
    def test_holidays_user_create_self(self):
        ...
        self.request_leave(
            self.user_hruser_id, datetime.today() + relativedelta(days=5), 1, values
        )
    ...
    def test_holidays_manager_create_self(self):
        ...
        self.request_leave(
            self.user_hrmanager_id, datetime.today() + relativedelta(days=5), 1, values
        )
...
class TestAccessRightsRead(TestHrHolidaysAccessRightsCommon):
    ...
    def test_leave_read_by_user_other(self):
        ...
        with self.assertRaises(AccessError), self.cr.savepoint():
            res = other_leave.with_user(self.user_employee_id).read(
...
class TestAccessRightsWrite(TestHrHolidaysAccessRightsCommon):
    ...
    def test_leave_manager_to_validate_by_user(self):
        ...
        hr_leave = self.request_leave(
            self.user_hruser_id, datetime.now() + relativedelta(days=2), 1, values
        )
        with self.assertRaises(AccessError):
    ...
    def test_leave_double_validate(self):
        ...
        hr_leave = self.request_leave(
            self.user_hruser_id, datetime.now() + relativedelta(days=6), 1, values
        )
    ...
    def test_leave_double_validate_holiday_manager(self):
        ...
        hr_leave = self.request_leave(
            self.user_hrmanager_id, datetime.now() + relativedelta(days=4), 1, values
        ).with_user(self.user_hrmanager_id)
...
class TestAccessRightsUnlink(TestHrHolidaysAccessRightsCommon):
    ...
    def test_leave_unlink_draft_by_user(self):
        ...
        leave = self.request_leave(
            self.user_employee_id, datetime.now() + relativedelta(days=5), 1, values
        )
    ...
    def test_leave_unlink_confirm_in_past_by_user(self):
        ...
        leave = self.request_leave(
            self.user_employee_id, datetime.now() + relativedelta(days=-4), 1, values
        )
