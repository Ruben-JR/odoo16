...
class TestGroupedExport(XlsxCreatorCase):
    ...
    def test_int_sum_max(self):
        ...
        export = self.export(
            ...
            params={"groupby": ["int_sum", "int_max"]},
        )
    ...
    def test_bool_and(self):
        ...
        export = self.export(
            values,
            fields=["int_sum", "bool_and"],
            params={"groupby": ["int_sum", "bool_and"]},
        )
    ...
    def test_bool_or(self):
        ...
        export = self.export(
            values,
            fields=["int_sum", "bool_or"],
            params={"groupby": ["int_sum", "bool_or"]},
        )
    ...
    def test_many2one(self):
        ...
        export = self.export(
            values,
            fields=["int_sum", "many2one"],
            params={"groupby": ["int_sum", "many2one"]},
        )
