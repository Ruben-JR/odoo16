...
class TestTaskDependencies(TestProjectCommon):
    ...
    def test_task_dependencies(self):
        ...
        self.assertEqual(
            len(self.task_1.depend_on_ids), 1, "The task 1 should have a dependency."
        )
        self.task_1.write(
            {
    ...
    def test_cyclic_dependencies(self):
        ...
        self.assertEqual(
            len(self.task_1.depend_on_ids), 1, "The task 1 should have one dependency."
        )
        ...
        self.assertEqual(
            len(self.task_2.depend_on_ids), 1, "The task 2 should have one dependency."
        )
    ...
    def test_task_dependencies_settings_change(self):
        def set_task_dependencies_setting(enabled):
            features_config = self.env["res.config.settings"].create(
        ...
        self.assertTrue(
            self.project_pigs.allow_task_dependencies,
