...
class TestSaleMrpKitBom(TransactionCase):
    ...
    def test_sale_kit_show_kit_in_delivery(self):
        ...
        self.assertTrue(
            pick.move_ids_without_package[0].bom_line_id,
            "All component from kits should have a bom line",
        )
        self.assertTrue(
            pick.move_ids_without_package[1].bom_line_id,
            "All component from kits should have a bom line",
        )
        self.assertTrue(
            ship.move_ids_without_package[0].bom_line_id,
            "All component from kits should have a bom line",
        )
        self.assertTrue(
            ship.move_ids_without_package[1].bom_line_id,
            "All component from kits should have a bom line",
        )
