...
class TestSaleTimesheetProjectProfitability(TestCommonSaleTimesheet):
    ...
    def test_get_project_profitability_items(self):
        ...
        SaleOrderLine = self.env["sale.order.line"].with_context(
            tracking_disable=True, default_order_id=sale_order.id
        )
        ...
        self.assertEqual(
            delivery_service_order_line.qty_delivered,
            0.0,
        ...
        self.assertEqual(
            ...
            delivery_timesheet_order_line,
            "The SOL of the timesheets should be the one of the task.",
        )
        self.assertEqual(
            delivery_timesheet_order_line.qty_delivered,
                    ...
                    "data": [
                        {
                            ...
                            "to_invoice": delivery_timesheet_order_line.untaxed_amount_to_invoice,
                            "invoiced": 0.0,
                        },
                    ],
                    "total": {
        ...
        self.assertDictEqual(
            ...
            ][0],
            {
                "id": "billable_milestones",
                "sequence": sequence_per_invoice_type["billable_milestones"],
                "to_invoice": milestone_order_line.untaxed_amount_to_invoice,
                "invoiced": 0.0,
            },
        )
