...
class TestDropship(common.TransactionCase):
    ...
    def test_00_dropship(self):
        ...
        self.assertTrue(
            sale_order_drp_shpng.procurement_group_id,
        ...
        self.assertEqual(
            purchase.state, "purchase", "Purchase order should be in the approved state"
        )
        ...
        # Send the 200 pieces
        purchase.picking_ids.move_ids.quantity_done = (
