...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        res = super()._prepare_all_journals(
    ...
    def _get_ar_responsibility_match(self, chart_template_id):
        ...
        match = {
            self.env.ref("l10n_ar.l10nar_base_chart_template").id: self.env.ref(
                "l10n_ar.res_RM"
            ),
            self.env.ref("l10n_ar.l10nar_ex_chart_template").id: self.env.ref(
                "l10n_ar.res_IVAE"
            ),
            self.env.ref("l10n_ar.l10nar_ri_chart_template").id: self.env.ref(
                "l10n_ar.res_IVARI"
            ),
        }
    ...
    def _load(self, company):
        ...
        if self == self.env.ref(
            "l10n_ar.l10nar_base_chart_template"
        ) or self == self.env.ref("l10n_ar.l10nar_ex_chart_template"):
