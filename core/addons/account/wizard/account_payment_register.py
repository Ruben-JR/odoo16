...
class AccountPaymentRegister(models.TransientModel):
        ...
        for wizard in self:
            ...
            if len(batches) == 1:
                ...
                wizard.can_group_payments = any(
                    len(batch_result["lines"]) != 1 for batch_result in batches
                )
    ...
    def _get_total_amount_using_same_currency(
        ...
        for aml in batch_result["lines"]:
            if early_payment_discount and aml._is_eligible_for_early_payment_discount(
                aml.currency_id, self.payment_date
            ):
            ...
            if wizard.can_edit_wizard:
                ...
                wizard.early_payment_discount_mode = (
                    wizard.currency_id.compare_amounts(
                        wizard.amount, total_amount_residual_in_wizard_currency
                    )
                    == 0
