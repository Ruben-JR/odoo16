...
class ProductProduct(models.Model):
    ...
    def _get_combination_info_variant(
        self, add_qty=1, pricelist=False, parent_combination=False
    ):
    ...
    def _filter_to_unlink(self):
        ...
        lines = self.env["sale.order.line"]._read_group(
...
class ProductAttributeCustomValue(models.Model):
    ...
    sale_order_line_id = fields.Many2one(
        "sale.order.line", string="Sales Order Line", required=True, ondelete="cascade"
    )
