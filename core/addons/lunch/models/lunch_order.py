...
class LunchOrder(models.Model):
    ...
    def _extract_toppings(self, values):
        ...
        if self.ids:
            ...
            topping_1 = (
                values.pop("topping_ids_1")[0][2]
                if "topping_ids_1" in values
                else self[:1].topping_ids_1.ids
            )
            topping_2 = (
                values.pop("topping_ids_2")[0][2]
                if "topping_ids_2" in values
                else self[:1].topping_ids_2.ids
            )
            topping_3 = (
                values.pop("topping_ids_3")[0][2]
                if "topping_ids_3" in values
                else self[:1].topping_ids_3.ids
            )
        else:
            topping_1 = (
                values["topping_ids_1"][0][2] if "topping_ids_1" in values else []
            )
            topping_2 = (
                values["topping_ids_2"][0][2] if "topping_ids_2" in values else []
            )
            topping_3 = (
                values["topping_ids_3"][0][2] if "topping_ids_3" in values else []
            )
