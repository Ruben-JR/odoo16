...
class TestUi(HttpCaseWithUserDemo, HttpCaseWithUserPortal):
    ...
    def test_01_admin_shop_customize_tour(self):
        ...
        self.start_tour(
            self.env["website"].get_client_action_url("/shop?search=Test Product"),
            "shop_customize",
            login="admin",
            timeout=120,
        )
    ...
    def test_02_admin_shop_custom_attribute_value_tour(self):
            ...
            [
                ...
                },
                {
                    ...
                    "value_ids": [
                        ...
                        (4, product_attribute_value_4.id),
                    ],
                },
            ]
        )
        ...
        self.product_product_4_product_template.attribute_line_ids[0].write(
            {"value_ids": [(4, product_attribute_value_7.id)]}
        )

        img_path = get_module_resource(
            "product", "static", "img", "product_product_11-image.png"
        )
        ...
        self.product_product_11_product_template.attribute_line_ids[
            0
        ].product_template_value_ids[1].price_extra = 6.40
        ...
        pricelists = self.env[
            "website"
        ].get_current_website().get_current_pricelist() | self.env.ref("product.list0")

        for pricelist in pricelists:
            if not pricelist.item_ids.filtered(
                lambda i: i.product_tmpl_id == product_template
                and i.price_discount == 20
            ):
                    ...
                    "value_ids": [
                        (
                            ...
                            attribute_values.filtered(
                                lambda v: v.attribute_id == attribute_1
                            ).ids,
                        )
                    ],
                },
                {
                    ...
                    "value_ids": [
                        (
                            ...
                            0,
                            attribute_values.filtered(
                                lambda v: v.attribute_id == attribute_2
                            ).ids,
                        )
                    ],
                },
                {
                    ...
                    "value_ids": [
                        (
                            ...
                            0,
                            attribute_values.filtered(
                                lambda v: v.attribute_id == attribute_3
                            ).ids,
                        )
                    ],
                },
