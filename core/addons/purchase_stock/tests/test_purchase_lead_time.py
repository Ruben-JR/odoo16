...
class TestPurchaseLeadTime(PurchaseTestCommon):
    def test_00_product_company_level_delays(self):
        ...
        self.assertEqual(
            purchase.order_line.date_planned,
            schedule_date,
        ...
        self.assertEqual(
            purchase.picking_ids.scheduled_date,
            schedule_date,
    ...
    def test_01_product_level_delay(self):
        ...
        self.assertEqual(
            purchase2.picking_ids.scheduled_date,
    ...
    def test_02_product_route_level_delays(self):
        ...
        incoming_shipment1 = self.env["stock.picking"].search(
            [
                ("move_ids.product_id", "in", (self.product_1.id, self.product_2.id)),
        ...
        self.assertEqual(
            incoming_shipment1.scheduled_date,
        ...
        self.assertEqual(
            incoming_shipment2.scheduled_date,
    ...
    def test_merge_po_line_3(self):
        ...
        order_line_description = (
            purchase_order.order_line.product_id.description_pickingin or ""
        )
        self.assertEqual(
            len(purchase_order.order_line), 1, "wrong number of order line is created"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            purchase_order.order_line.filtered(lambda x: x.product_qty == 15).name,
            t_shirt.display_name + "\n" + "Color (Red)",
            "wrong description in po lines",
        )
        self.assertEqual(
            purchase_order.order_line.filtered(lambda x: x.product_qty == 10).name,
            t_shirt.display_name + "\n" + "Color (Green)",
            "wrong description in po lines",
        )
        ...
        self.assertEqual(
            ...
            .move_ids_without_package.filtered(lambda x: x.product_uom_qty == 15)
            .description_picking,
        ...
        self.assertEqual(
            purchase_order.picking_ids[0]
            .move_ids_without_package.filtered(lambda x: x.product_uom_qty == 10)
            .description_picking,
