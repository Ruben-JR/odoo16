...
class TestCertificationFlow(common.TestSurveyCommon, HttpCase):
    def test_flow_certification(self):
        ...
        with patch.object(IrMailServer, "connect"):
            ...
            self._answer_question(
                q04, q04.suggested_answer_ids.ids[0], answer_token, csrf_token
            )
            self._answer_question(
                q05,
                [
                    q05.suggested_answer_ids.ids[0],
                    q05.suggested_answer_ids.ids[1],
        ...
        self.assertEqual(
            certification_email.attachment_ids[0].name, "Certification Document.html"
        )
