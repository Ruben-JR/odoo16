...
class TestQweb(TransactionCaseWithUserDemo):
    ...
    def test_qweb_cdn(self):
        ...
        html = demo_env["ir.qweb"]._render(
            "website.test_template", {"user": demo}, website_id=website.id
        )
        ...
        attachments = demo_env["ir.attachment"].search(
            [("url", "=like", "/web/assets/%-%/website.test_bundle.%")]
        )
