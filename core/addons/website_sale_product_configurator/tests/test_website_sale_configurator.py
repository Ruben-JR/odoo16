...
from odoo.addons.sale_product_configurator.tests.common import (
...
class TestWebsiteSaleProductConfigurator(
    TestProductConfiguratorCommon, HttpCaseWithUserPortal
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        ptav_ids = (
            cls.product_product_custo_desk.attribute_line_ids.product_template_value_ids
        )
    ...
    def test_01_product_configurator_variant_price(self):
        ...
        ptav_ids = (
            self.product_product_custo_desk.attribute_line_ids.product_template_value_ids
        )
        parent_combination = ptav_ids.filtered(
            lambda ptav: ptav.name in ("Aluminium", "White")
        )
        ...
        self.start_tour(
            url,
            "website_sale_product_configurator_optional_products_tour",
            login="portal",
        )
