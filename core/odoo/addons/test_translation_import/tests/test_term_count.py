...
class TestImport(common.TransactionCase):
    def test_import_code_translation(self):
        ...
        self.assertEqual(
            model.with_context(lang="fr_FR").get_code_translation(), "Code, Français"
        )
    ...
    def test_noupdate(self):
        ...
        self.assertEqual(
            menu.with_context(lang="fr_FR").name, "Test translation import in french"
        )
    ...
    def test_lang_with_base(self):
        ...
        self.assertEqual(
            record.with_context(lang="fr_CA").get_code_translation(), "Code, Français"
        )
    ...
    def test_import_from_po_file(self):
        ...
        self.assertEqual(
            record.with_context(lang="tlh").get_code_translation(), "Code, Klingon"
        )
    ...
    def test_import_from_csv_file(self):
        ...
        self.assertEqual(
            record.with_context(lang="dot").get_code_translation(), "Code, English"
        )
