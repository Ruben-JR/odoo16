...
class Onboarding(models.Model):
    ...
    step_ids = fields.One2many(
        "onboarding.onboarding.step", "onboarding_id", "Onboarding steps"
    )
    ...
    panel_background_color = fields.Selection(
        ...
        string="Panel's Background color",
        default="orange",
        ...
        for onboarding in self:
            ...
            if current_progress_id:
                if len(current_progress_id) > 1:
                    current_progress_id = current_progress_id.sorted(
    ...
    def _prepare_rendering_values(self):
        ...
        values = {
            ...
            if self.panel_background_color not in {False, "none"}
            else "",
