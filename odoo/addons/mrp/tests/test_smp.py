...
class TestMrpSerialMassProduce(TestMrpCommon):
    ...
    def test_smp_produce_all(self):
        ...
        self.assertEqual(
            mo.procurement_group_id.mrp_production_ids.lot_producing_id.mapped("name"),
    ...
    def test_smp_produce_complex(self):
        ...
        Check lot splitting.
        """
        mo, dummy, dummy, product_to_use_1, product_to_use_2 = self.generate_mo(
        ...
        self.assertEqual(
            mo.procurement_group_id.mrp_production_ids[2]
            .move_raw_ids[1]
            .move_lines_count,
            1,
        )
        ...
        self.assertEqual(
            mo.procurement_group_id.mrp_production_ids[1]
            .move_raw_ids[1]
            .move_lines_count,
            2,
        )
