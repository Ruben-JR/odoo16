...
class MailComposeMessage(models.TransientModel):
    ...
    def get_mail_values(self, res_ids):
        ...
        if (
            ...
            .sudo()
            .search_count([("model", "=", self.model), ("is_mail_thread", "=", True)])
        ):
            ...
            for res_id in res_ids:
                ...
                trace_vals = {
                    ...
                    "email": recipients_info[res_id]["mail_to"][0]
                    if recipients_info[res_id]["mail_to"]
                    else "",
                }
    ...
    def _get_optout_emails(self, mail_values_dict):
        opt_out_list = super(MailComposeMessage, self)._get_optout_emails(
            mail_values_dict
        )
        if self.mass_mailing_id:
