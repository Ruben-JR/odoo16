...
class AuthConfirm(AuthSignupHome):
    ...
    @http.route("/web/signup/views/", type="http", auth="public")
    def views(self, *args):
        # Show how to complete registration
        return http.request.render("health_signup_verification.index")
    ...
    def web_auth_signup(self, *args, **kw):
        ...
        try:
            ...
            registration_redirect_url = (
                ...
                .sudo()
                .get_param("health_signup_verification.url_singup_views")
            )
    ...
    def _singup_with_confirmation(self, *args, **kw):
        ...
        # send email
        template = request.env.ref("health_signup_verification.email_registration")
