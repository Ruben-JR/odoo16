...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            [{"email": record.email_normalized} for record in recipients],
            mailing,
            recipients,
            mail_links_info=[
                [
    ...
    def test_mailing_w_blacklist_nomixin(self):
        ...
        self.assertMailTraces(
            [
                {
                    "email": email_normalize(test_records[0].email_from),
                    "trace_status": "cancel",
                    "failure_type": "mail_bl",
                },
                {
                    "email": email_normalize(test_records[1].email_from),
                    "trace_status": "sent",
                },
            ],
            self.mailing_bl,
