...
class TestReInvoice(TestSaleCommon):
    ...
    def test_at_cost(self):
        ...
        self.assertEqual(
            ...
            (self.company_data["product_delivery_cost"].standard_price, 3, 0, 0),
            "Sale line is wrong after confirming vendor invoice",
        )
        ...
        self.assertEqual(
            ...
            (self.company_data["product_delivery_cost"].standard_price, 2, 0, 0),
    ...
    def test_sales_price(self):
        ...
        self.assertEqual(
            ...
            (self.company_data["product_delivery_sales_price"].list_price, 3, 0, 0),
            "Sale line is wrong after confirming vendor invoice",
        )
        self.assertEqual(
            (
            ...
            (self.company_data["product_order_sales_price"].list_price, 3, 0, 0),
            "Sale line is wrong after confirming vendor invoice",
        )
        ...
        self.assertEqual(
            ...
            (self.company_data["product_order_sales_price"].list_price, 2, 0, 0),
    ...
    def test_not_reinvoicing_invoiced_so_lines(self):
        ...
        so_line3 = self.sale_order.order_line.filtered(
            lambda sol: sol != so_line1
            and sol.product_id == self.company_data["product_delivery_cost"]
        )
        so_line4 = self.sale_order.order_line.filtered(
            lambda sol: sol != so_line2
            and sol.product_id == self.company_data["product_delivery_sales_price"]
        )
    ...
    def test_refund_delivered_reinvoiced(self):
        ...
        self.assertRecordValues(
            self.sale_order.order_line[-2:],
            [{"qty_delivered": 20}, {"qty_delivered": 20}],
        )
        ...
        self.assertRecordValues(
            self.sale_order.order_line[-2:],
            [{"qty_delivered": 10}, {"qty_delivered": 15}],
        )
