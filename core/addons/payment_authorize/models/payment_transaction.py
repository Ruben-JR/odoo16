...
class PaymentTransaction(models.Model):
    ...
    def _send_refund_request(self, amount_to_refund=None):
        ...
        if tx_status in TRANSACTION_STATUS_MAPPING["voided"]:
            ...
            tx_status in TRANSACTION_STATUS_MAPPING[k]
            ...
            if tx_status in TRANSACTION_STATUS_MAPPING["authorized"]:
                ...
                rounded_amount = round(
                    amount_to_refund, self.currency_id.decimal_places
                )
            ...
            raise ValidationError(
                ...
                + _(
                    ...
                    tx_status,
                    tx_details.get("messages", {}).get("message"),
                )
            )
        return refund_tx
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        tx = self.search(
            [("reference", "=", reference), ("provider_code", "=", "authorize")]
        )
        if not tx:
            raise ValidationError(
                "Authorize.Net: "
