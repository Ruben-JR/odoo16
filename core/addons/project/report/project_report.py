...
class ReportProjectTaskUser(models.Model):
    ...
    delay_endings_days = fields.Float(
        string="Days to Deadline", digits=(16, 2), group_operator="avg", readonly=True
    )
    nbr = fields.Integer(
    ...
    rating_last_text = fields.Selection(
        RATING_TEXT,
        string="Rating Last Text",
        compute="_compute_rating_last_text",
        search="_search_rating_last_text",
    )
