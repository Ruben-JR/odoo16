...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        session_info = {
            ...
            if session_uid
            else None,  # YTI TODO: Remove this from the user context
            "partner_id": user.partner_id.id
            if session_uid and user.partner_id
            else None,
            ...
            "cache_hashes": {
                "translations": self.env["ir.http"]
                .sudo()
                .get_web_translations_hash(mods, request.session.context["lang"])
                if session_uid
                else None,
            },
    ...
    def get_frontend_session_info(self):
        ...
        session_info = {
            ...
            "show_effect": bool(
                ...
                .sudo()
                .get_param("base_setup.show_effect")
            ),
            "bundle_params": {
                "lang": request.session.context["lang"],
            },
