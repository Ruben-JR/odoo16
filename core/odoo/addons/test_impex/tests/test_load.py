...
class ImporterCase(common.TransactionCase):
    ...
    def import_(self, fields, rows, context=None):
        context = context or {}
        context.update({"import_file": True})
...
class test_float_field(ImporterCase):
    ...
    def test_positives(self):
        ...
        self.assertEqual(
            [1, 42, 2**31 - 1, 12345678, 2.0**33, 0.000001], values(self.read())
        )
    ...
    def test_negatives(self):
        ...
        self.assertFalse(result["messages"])
        self.assertEqual(
            [-1, -42, -(2**31 - 1), -(2**31), -12345678, -(2.0**33), -0.000001],
            values(self.read()),
        )
    ...
    def test_imported(self):
        result = self.import_(
            ...
            [
                ...
                [
                    "People 'get' types. They use them all the time. Telling "
                    "someone he can't pound a nail with a banana doesn't much "
                    "surprise him."
                ],
            ],
        )
    ...
    def test_imported(self):
        result = self.import_(
            ...
            [
                ...
                # ackbar.jpg
                [
                    "If they ask you about fun, you tell them – fun is a filthy"
                    " parasite"
                ],
            ],
        )
...
class test_required_string_field(ImporterCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(
            result["messages"],
            [message("Missing required value for the field 'Value' (value)")],
        )
        self.assertIs(result["ids"], False)
    ...
    def test_ignore_excess_messages(self):
        ...
        for m in result["messages"][:-1]:
            ...
            self.assertEqual(
                m["message"], "Missing required value for the field 'Value' (value)"
            )
...
class test_selection_function(ImporterCase):
    ...
    def test_translated(self):
        ...
        self.addCleanup(
            code_translations.python_translations.pop, ("test_impex", "fr_FR")
        )
...
class test_m2o(ImporterCase):
    ...
    def test_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name '%s' in field 'Value'" % id,
                    from_=index,
                    to_=index,
                    record=index,
    ...
    def test_sub_field(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "Can not create Many-To-One records indirectly, import "
    ...
    def test_fail_noids(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name 'nameisnoexist:3' "
                    "in field 'Value'",
                    moreinfo=moreaction(res_model="export.integer"),
                    field_name="Value",
                    field_path=["value"],
    ...
    def test_fail_multiple(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "Ambiguous specification for field 'Value', only provide one of "
                    "name, external id or database id"
                )
            ],
        )
        self.assertIs(result["ids"], False)
...
class test_m2m(ImporterCase):
    ...
    def test_nonames(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name 'wherethem2mhavenonames' in "
                    "field 'Value'",
...
class test_date(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "'not really a date' does not seem to be a valid date "
                    "for field 'Value'",
...
class test_datetime(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "'not really a datetime' does not seem to be a valid "
                    "datetime for field 'Value'",
...
class test_unique(ImporterCase):
    ...
    def test_unique(self):
        ...
        self.assertEqual(
            ...
            [
                dict(
                    message="The value for the field 'value' already exists "
                    "(this is probably 'Value' in the current model).",
                    type="error",
                    rows={"from": 1, "to": 1},
                    record=1,
                    field="value",
...
class test_inherits(ImporterCase):
    ...
    def test_update_parent_no_xid(self):
        ...
        self.import_(["id", "value"], [["xxx.child", "42"]])
