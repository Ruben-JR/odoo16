...
class TestAngloSaxonCommon(common.TransactionCase):
    def setUp(self):
        ...
        self.category = self.category.copy(
...
class TestAngloSaxonFlow(TestAngloSaxonCommon):
    ...
    def test_cogs_with_ship_later_no_invoicing(self):
        ...
        self.assertEqual(
            aml_output[1].credit, 0.0, "Cost of Good Sold entry missing or mismatching"
        )
        self.assertEqual(
            aml_expense[0].credit,
            self.product.standard_price,
            "Cost of Good Sold entry missing or mismatching",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            aml_output[0].debit, 0.0, "Cost of Good Sold entry missing or mismatching"
        )
        self.assertEqual(
            aml_output[0].credit, 0.0, "Cost of Good Sold entry missing or mismatching"
        )
        self.assertEqual(
            aml_expense[1].credit, 0.0, "Cost of Good Sold entry missing or mismatching"
        )
        self.assertEqual(
