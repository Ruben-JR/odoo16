...
class ReturnPicking(models.TransientModel):
    ...
    product_return_moves = fields.One2many(
        "stock.return.picking.line", "wizard_id", "Moves"
    )
    ...
    def _onchange_picking_id(self):
        ...
        if self.picking_id:
            ...
            self.parent_location_id = (
                self.picking_id.picking_type_id.warehouse_id
                and self.picking_id.picking_type_id.warehouse_id.view_location_id.id
                or self.picking_id.location_id.location_id.id
            )
    ...
    def _prepare_stock_return_picking_line_vals_from_move(self, stock_move):
        ...
        for move in stock_move.move_dest_ids:
            if (
                ...
                and move.origin_returned_move_id != stock_move
            ):
                continue
        ...
        quantity = float_round(
            quantity, precision_rounding=stock_move.product_id.uom_id.rounding
        )
        return {
    ...
    def _prepare_move_default_values(self, return_line, new_picking):
        vals = {
            ...
            or return_line.move_id.location_id.id,
