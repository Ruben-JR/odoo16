...
class TestStockLandedCostsMrp(ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_refrigerator = cls.env["product.product"].create(
            {"name": "Refrigerator", "type": "product", "categ_id": cls.categ_all.id}
        )
        ...
        cls.product_refrigerator.categ_id.property_stock_account_input_categ_id = (
            cls.company_data["default_account_stock_in"]
        )
        cls.product_refrigerator.categ_id.property_stock_account_output_categ_id = (
            cls.company_data["default_account_stock_out"]
        )
