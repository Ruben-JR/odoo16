...
class TestHrAttendance(TransactionCase):
    ...
    def test_checkin_self_without_pin(self):
        ...
        self.assertEqual(
            ...
            "checked_in",
            "He should be able to check in without pin",
        )
        employee.attendance_manual({}, entered_pin=None)
        self.assertEqual(
            employee.attendance_state,
            "checked_out",
            "He should be able to check out without pin",
        )
    ...
    def test_checkin_self_with_pin(self):
        ...
        self.assertEqual(
            employee.attendance_state,
            "checked_in",
            "He should be able to check in with his pin",
        )
        employee.attendance_manual({}, entered_pin="1234")
        self.assertEqual(
            employee.attendance_state,
            "checked_out",
            "He should be able to check out with his pin",
        )
    ...
    def test_checkin_self_wrong_pin(self):
        ...
        self.assertNotEqual(
            employee.attendance_state,
            "checked_in",
            "He should not be able to check in with a wrong pin",
        )
    ...
    def test_checkin_kiosk_without_pin(self):
        ...
        self.assertNotEqual(
            employee.attendance_state,
            "checked_in",
            "He should not be able to check in with no pin",
        )
        self.assertTrue(action.get("warning"))
    ...
    def test_checkin_kiosk_no_pin_mode(self):
        ...
        self.assertEqual(
            employee.attendance_state,
            "checked_out",
            "He shouldn't be able to check in without",
        )
    ...
    def test_hours_today(self):
        ...
        with patch.object(
            fields.Datetime,
            "now",
            lambda: tz_datetime(2019, 3, 2, 14, 0)
            .astimezone(pytz.utc)
            .replace(tzinfo=None),
        ):
