...
class Product(models.Model):
    ...
    product_variant_image_ids = fields.One2many(
        "product.image", "product_variant_id", string="Extra Variant Images"
    )
    ...
    def _is_add_to_cart_allowed(self):
        ...
        return self.user_has_groups("base.group_system") or (
            self.active and self.sale_ok and self.website_published
        )
