...
class TestBarcode(TransactionCase):
    ...
    def test_barcode_encoding(self):
        ...
        self.assertFalse(
            check_barcode_encoding("2022a006", "ean8"), "should contains digits only"
        )
        self.assertFalse(
            check_barcode_encoding("20220000", "ean8"), "incorrect check digit"
        )
        self.assertFalse(
            check_barcode_encoding("93855341", "ean13"), "ean13 is a 13-digits barcode"
        )
        self.assertFalse(
        ...
        self.assertFalse(
            check_barcode_encoding("9745213796148", "ean13"), "incorrect check digit"
        )
        self.assertFalse(
