...
class StockMove(TransactionCase):
    ...
    def test_in_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.supplier_location
            ),
            0.0,
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.supplier_location, allow_negative=True
            ),
            -100.0,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.supplier_location)), 1.0
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 1.0
        )
    ...
    def test_out_1(self):
        ...
        with self.assertRaises(
            UserError, msg="It should not be possible to write directly to reserved_qty"
        ):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.customer_location
            ),
            100.0,
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.customer_location)), 1.0
        )
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 0.0
        )
    ...
    def test_out_2(self):
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.customer_location)), 0.0
        )
        # there should be no quant amymore in the stock location
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
    ...
    def test_putaway_with_storage_category_2(self):
        ...
        storage_category_form = Form(
            storage_category, view="stock.stock_storage_category_form"
        )
    ...
    def test_availability_1(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 150.0
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 1.0
        )
    ...
    def test_availability_2(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 50.0
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 1.0
        )
    ...
    def test_availability_4(self):
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 30.0
        )
        move1 = self.env["stock.move"].create(
            {
    ...
    def test_availability_6(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 6.0
        )
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 4.0
        )
        move._action_assign()
    ...
    def test_unreserve_2(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 150.0, package_id=package1
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, package_id=package1
            ),
            150.0,
        )
        self.assertEqual(move1.availability, 100.0)
    ...
    def test_unreserve_3(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 2
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 1.0
        )
    ...
    def test_unreserve_5(self):
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location)), 2
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location
    ...
    def test_link_assign_2(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, lot_id=lot1
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location, lot1)), 1.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, lot_id=lot1
            ),
            0.0,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.pack_location, lot1)), 0.0
        )
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location, lot1)), 0.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.pack_location, lot_id=lot1
            ),
            0.0,
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.pack_location, lot1)), 1.0
        )
    ...
    def test_link_assign_3(self):
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product, self.pack_location)), 1.0
        )
    ...
    def test_link_assign_4(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 2.0, lot_id=lot1
        )
        self.assertEqual(
            len(self.gather_relevant(self.product, self.stock_location, lot1)), 1.0
        )
    ...
    def test_link_assign_7(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, move_stock_pack.location_dest_id
            ),
            6,
        )
    ...
    def test_use_reserved_move_line_2(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 12.0
        )
    ...
    def test_edit_reserved_move_line_1(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, shelf1_location, 1.0
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product, shelf2_location, 1.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, shelf1_location
            ),
            1.0,
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, shelf2_location
            ),
            1.0,
        )
        self.assertEqual(
    ...
    def test_edit_reserved_move_line_2(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, lot_id=lot2
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, lot_id=lot2
            ),
            1.0,
        )
    ...
    def test_edit_reserved_move_line_3(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, package_id=package1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, package_id=package2
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, package_id=package2
            ),
            1.0,
        )
    ...
    def test_edit_reserved_move_line_4(self):
        ...
        """
        owner1 = self.env["res.partner"].create(
            {"name": "test_edit_reserved_move_line_4_1"}
        )
        owner2 = self.env["res.partner"].create(
            {"name": "test_edit_reserved_move_line_4_2"}
        )

        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, owner_id=owner1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, owner_id=owner2
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, owner_id=owner1
            ),
            1.0,
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, owner_id=owner2
            ),
            1.0,
        )
    ...
    def test_edit_reserved_move_line_5(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, lot_id=lot1, package_id=package1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 1.0, lot_id=lot2
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, lot_id=lot1, package_id=package1
            ),
            1.0,
        )
        self.assertEqual(
    ...
    def test_edit_reserved_move_line_8(self):
        ...
        self.assertEqual(
            untracked_move_line.reserved_qty, 3
        ...
        move1._action_done()
        self.assertEqual(
            untracked_move_line.reserved_qty, 0
        )  # change reservation to 0 for done move
        self.assertEqual(
            tracked_move_line.reserved_qty, 0
        )  # change reservation to 0 for done move
        self.assertEqual(move1.state, "done")
    ...
    def test_edit_reserved_move_line_9(self):
        ...
        self.assertEqual(
            out_move.move_line_ids.reserved_uom_qty,
            0,
            "The reserved quantity should be cancelled",
        )
    ...
    def test_edit_done_move_line_6(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, shelf2_location, allow_negative=True
            ),
            -1.0,
        )
    ...
    def test_edit_done_move_line_8(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, shelf1_location, allow_negative=True
            ),
            -1.0,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product, self.stock_location, allow_negative=True
            ),
            -1.0,
        )
    ...
    def test_immediate_validate_4(self):
        ...
        self.assertEqual(
            immediate_trans_wiz_dict.get("res_model"), "stock.immediate.transfer"
        )
        immediate_trans_wiz = Form(
            self.env[immediate_trans_wiz_dict["res_model"]].with_context(
    ...
    def test_immediate_validate_8(self):
        ...
        self.assertEqual(
            immediate_trans_wiz.immediate_transfer_line_ids.mapped("to_immediate"),
            [True, True],
        )
        # Only transfer receipt1
        immediate_trans_wiz.immediate_transfer_line_ids.filtered(
            lambda line: line.picking_id == receipt2
        ).to_immediate = False
        immediate_trans_wiz.process()
    ...
    def test_scrap_5(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 4
        )
    ...
    def test_scrap_6(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._gather(self.product, self.stock_location).quantity,
            -11,
        )
    ...
    def test_scrap_7_sn_warning(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product_serial, child_loc1, 1, lot1
        )
        ...
        self.assertEqual(
            scrap.location_id, child_loc1, "Location was not auto-corrected"
        )
    ...
    def test_scrap_8(self):
        ...
        scrap_location = self.env["stock.location"].search(
            [("company_id", "=", self.env.company.id), ("scrap_location", "=", True)],
            limit=1,
        )
        internal_operation = (
    ...
    def test_initial_demand_4(self):
        ...
        """
        self.env["stock.quant"]._update_available_quantity(
            self.product, self.stock_location, 12
        )
        picking = self.env["stock.picking"].create(
            {
                "location_id": self.stock_location.id,
    ...
    def test_put_in_pack_2(self):
        ...
        self.assertEqual(len(picking.move_line_ids), 2)
        self.assertEqual(
            picking.move_line_ids[0].qty_done,
            1,
            "Stock move line should have 1 quantity as a done quantity.",
        )
        self.assertEqual(
            picking.move_line_ids[1].qty_done,
            2,
    ...
    def test_move_line_aggregated_product_quantities(self):
        ...
        aggregate_val_1 = aggregate_values[
            f"{self.product.id}_{self.product.name}__{sml1.product_uom_id.id}"
        ]
        aggregate_val_2 = aggregate_values[
            f"{product2.id}_{product2.name}__{sml2.product_uom_id.id}"
        ]
        ...
        aggregate_val_3 = aggregate_values[
            f"{product3.id}_{product3.name}__{sml3.product_uom_id.id}"
        ]
        ...
        aggregate_val_1 = aggregate_values[
            f"{product3.id}_{product3.name}__{sml1.product_uom_id.id}"
        ]
        aggregate_val_2 = aggregate_values[
            f"{product2.id}_{product2.name}__{sm2.product_uom.id}"
        ]
    ...
    def test_move_line_aggregated_product_quantities_duplicate_stock_move(self):
        ...
        aggregated_val = aggregate_values[
            f"{self.product.id}_{self.product.name}__{self.product.uom_id.id}"
        ]
    ...
    def test_move_sn_warning(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product_serial, self.pack_location, 1, lot1
        )
    ...
    def test_forecast_availability(self):
        ...
        # make some stock
        self.env["stock.quant"]._update_available_quantity(
            product, self.stock_location, 36.0
        )
        # create picking
    ...
    def test_SML_location_selection(self):
        ...
        self.env.user.write(
            {
                "groups_id": [
                    (3, self.env.ref("stock.group_stock_storage_categories").id)
                ]
            }
        )
        ...
        self.assertEqual(
            picking.move_line_ids_without_package.location_dest_id,
            self.stock_location.child_ids[0],
        )
        ...
        picking = self.env["stock.picking"].create(
            {
                ...
                "move_line_nosuggest_ids": [
                    Command.create({"product_id": self.product.id, "qty_done": 1.0})
                ],
            }
        )
