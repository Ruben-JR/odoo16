...
class TestBatchPicking(TransactionCase):
    ...
    def test_batch_scheduled_date(self):
        ...
        self.assertEqual(
            self.batch.scheduled_date, self.picking_client_2.scheduled_date
        )
        ...
        self.assertEqual(
            self.batch.scheduled_date, self.picking_client_3.scheduled_date
        )
    ...
    def test_simple_batch_with_wizard(self):
        ...
        immediate_transfer_wizard = Form(
            self.env[(immediate_transfer_wizard_dict.get("res_model"))].with_context(
    ...
    def test_batch_with_backorder_wizard(self):
        ...
        back_order_wizard = Form(
            self.env[(back_order_wizard_dict.get("res_model"))].with_context(
    ...
    def test_auto_batch_02(self):
        ...
        * Result: 6 pickings and 3 batchs
        ...
        procurement_1 = self.env["procurement.group"].create(
            {"move_type": "direct", "partner_id": self.client_1.id}
        )
        ...
        self.assertEqual(
            procurement_1.stock_move_ids.picking_id[0].batch_id,
            procurement_2.stock_move_ids.picking_id[0].batch_id,
        )
        self.assertEqual(
            procurement_1.stock_move_ids.picking_id[1].batch_id,
            procurement_2.stock_move_ids.picking_id[1].batch_id,
        )
        self.assertEqual(
            procurement_1.stock_move_ids.picking_id[2].batch_id,
            procurement_2.stock_move_ids.picking_id[2].batch_id,
        )
