...
class TestSyncMicrosoft2Odoo(TransactionCase):
        ...
        self.single_event = [
            {
                ...
                "start": {"dateTime": "2020-05-05T14:30:00.0000000", "timeZone": "UTC"},
                "end": {"dateTime": "2020-05-05T16:00:00.0000000", "timeZone": "UTC"},
                "location": {"displayName": "a meeting room at Odoo"},
            }
        ]
    ...
    def test_cancel_occurence_of_recurrent_event(self):
        ...
        first_sync_values = [
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"pynKRnkCyUmnqILQHcLZEQAABElcNQ=="',
                "createdDateTime": "2021-07-15T14:47:40.2996962Z",
                "lastModifiedDateTime": "2021-07-15T14:47:40.3783507Z",
                "changeKey": "pynKRnkCyUmnqILQHcLZEQAABElcNQ==",
                "categories": [],
                "transactionId": None,
                "originalStartTimeZone": "Romance Standard Time",
                "originalEndTimeZone": "Romance Standard Time",
                "iCalUId": "040000008200E00074C5B7101A82E00800000000B35B3B5A8879D70100000000000000001000000008A0949F4EC0A1479E4ED178D87EF679",
                "reminderMinutesBeforeStart": 15,
                "isReminderOn": True,
                "hasAttachments": False,
                "subject": "Recurrent Event 1646",
                "bodyPreview": "",
                "importance": "normal",
                "sensitivity": "normal",
                "isAllDay": False,
                ...
                "showAs": "tentative",
                "type": "seriesMaster",
                "webLink": "https://outlook.live.com/owa/?itemid=AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgBGAAADZ59RIxdyh0Kt%2FMXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAA%3D&exvsurl=1&path=/calendar/item",
                "onlineMeetingUrl": None,
                "isOnlineMeeting": False,
                "onlineMeetingProvider": "unknown",
                "allowNewTimeProposals": True,
                ...
                "body": {"contentType": "html", "content": ""},
                "start": {"dateTime": "2021-07-15T15:00:00.0000000", "timeZone": "UTC"},
                "end": {"dateTime": "2021-07-15T15:30:00.0000000", "timeZone": "UTC"},
                "location": {
                    "displayName": "",
                    "locationType": "default",
                    "uniqueIdType": "unknown",
                ...
                "attendees": [
                    {
                        ...
                        "emailAddress": {
                            "name": "Odoo02 Outlook02",
                            "address": "odoo_bf_user02@outlook.com",
                        },
                    },
                    {
                        "type": "required",
                        "status": {"response": "none", "time": "0001-01-01T00:00:00Z"},
                        "emailAddress": {
                            "name": "Odoo01 Outlook01",
                            "address": "odoo_bf_user01@outlook.com",
                        },
                    },
                ],
                "organizer": {
            ...
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"DwAAABYAAACnKcpGeQLJSaeogtAdwtkRAAAESVw1"',
                "seriesMasterId": ("%s" % microsoft_id),
                "type": "occurrence",
                "id": "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlHI305wABGAAACZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ",
                "start": {"dateTime": "2021-07-15T15:00:00.0000000", "timeZone": "UTC"},
                "end": {"dateTime": "2021-07-15T15:30:00.0000000", "timeZone": "UTC"},
            },
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"DwAAABYAAACnKcpGeQLJSaeogtAdwtkRAAAESVw1"',
                "seriesMasterId": microsoft_id,
                "type": "occurrence",
                "id": "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlH7KejgABGAAACZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ",
                "start": {"dateTime": "2021-07-16T15:00:00.0000000", "timeZone": "UTC"},
                "end": {"dateTime": "2021-07-16T15:30:00.0000000", "timeZone": "UTC"},
            },
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"DwAAABYAAACnKcpGeQLJSaeogtAdwtkRAAAESVw1"',
                "seriesMasterId": microsoft_id,
                "type": "occurrence",
                "id": "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlItdINQABGAAACZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ",
                "start": {"dateTime": "2021-07-17T15:00:00.0000000", "timeZone": "UTC"},
                "end": {"dateTime": "2021-07-17T15:30:00.0000000", "timeZone": "UTC"},
            },
        ]
        second_sync_values = [
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"pynKRnkCyUmnqILQHcLZEQAABElcUw=="',
                "createdDateTime": "2021-07-15T14:47:40.2996962Z",
                "lastModifiedDateTime": "2021-07-15T14:51:25.2560888Z",
                "changeKey": "pynKRnkCyUmnqILQHcLZEQAABElcUw==",
                "categories": [],
                "transactionId": None,
                "originalStartTimeZone": "Romance Standard Time",
                "originalEndTimeZone": "Romance Standard Time",
            ...
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"DwAAABYAAACnKcpGeQLJSaeogtAdwtkRAAAESVxT"',
                "seriesMasterId": microsoft_id,
                "type": "occurrence",
                "id": "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlHI305wABGAAACZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ",
                "start": {"dateTime": "2021-07-15T15:00:00.0000000", "timeZone": "UTC"},
            ...
            },
            {
                "@odata.type": "#microsoft.graph.event",
                "@odata.etag": 'W/"pynKRnkCyUmnqILQHcLZEQAABElcUw=="',
                "createdDateTime": "2021-07-15T14:51:25.1366139Z",
                "lastModifiedDateTime": "2021-07-15T14:51:25.136614Z",
                "changeKey": "pynKRnkCyUmnqILQHcLZEQAABElcUw==",
                "categories": [],
                "transactionId": None,
                "originalStartTimeZone": "Romance Standard Time",
                "originalEndTimeZone": "Romance Standard Time",
                "iCalUId": "040000008200E00074C5B7101A82E00807E50710B35B3B5A8879D70100000000000000001000000008A0949F4EC0A1479E4ED178D87EF679",
                "reminderMinutesBeforeStart": 15,
                "isReminderOn": True,
                "hasAttachments": False,
                "subject": "Canceled: Recurrent Event 1646",
                "bodyPreview": "",
                "importance": "high",
                "sensitivity": "normal",
                "originalStart": "2021-07-16T15:00:00Z",
                "isAllDay": False,
                "isCancelled": True,
                "isOrganizer": False,
                "IsRoomRequested": False,
                ...
                "showAs": "free",
                "type": "exception",
                "webLink": "https://outlook.live.com/owa/?itemid=AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlH7KejgABGAAACZ59RIxdyh0Kt%2FMXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ&exvsurl=1&path=/calendar/item",
                "onlineMeetingUrl": None,
                "isOnlineMeeting": False,
                "onlineMeetingProvider": "unknown",
                "allowNewTimeProposals": True,
                "OccurrenceId": ("OID.%s.2021-07-16" % microsoft_id),
                "isDraft": False,
                "hideAttendees": False,
                "CalendarEventClassifications": [],
                "id": "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgFRAAgIANlH7KejgABGAAACZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAAQ",
        ...
        recurrent_event = self.env["calendar.recurrence"].search(
            [
                (
                    "microsoft_id",
                    "=",
                    "AQMkADAwATM3ZmYAZS0zZmMyLWYxYjQtMDACLTAwCgBGAAADZ59RIxdyh0Kt-MXfyCpfwAcApynKRnkCyUmnqILQHcLZEQAAAgENAAAApynKRnkCyUmnqILQHcLZEQAAAARKsSQAAAA=",
                )
            ]
        )
    ...
    def test_use_specific_virtual_location(self):
        ...
        ms_event[0]["location"][
            "displayName"
        ] = "https://teams.microsoft.com/l/meeting/1234"
        ...
        self.assertEqual(
            event.videocall_location, ms_event[0]["location"]["displayName"]
        )
    ...
    def test_outlook_event_has_online_meeting_url(self):
        ...
        self.assertEqual(
            event.videocall_location, ms_event[0]["onlineMeeting"]["joinUrl"]
        )
