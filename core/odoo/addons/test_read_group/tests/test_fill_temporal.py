...
class TestFillTemporal(common.TransactionCase):
    ...
    def test_date_range_with_context_timezone(self):
        ...
        for tz in tzs:
            ...
            groups = model_fill.read_group(
                [], fields=["date", "value"], groupby=["date"]
            )
            self.assertEqual(groups, expected)
    ...
    def test_timestamp_without_timezone(self):
        ...
        expected = [
            {
                ...
                "__range": {
                    "datetime": {
                        "from": "1916-08-01 00:00:00",
                        "to": "1916-09-01 00:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime": {
                        "from": "1916-09-01 00:00:00",
                        "to": "1916-10-01 00:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime": {
                        "from": "1916-10-01 00:00:00",
                        "to": "1916-11-01 00:00:00",
                    }
                },
        ...
        groups = self.Model.read_group(
            [], fields=["datetime", "value"], groupby=["datetime"]
        )

        self.assertEqual(
            groups, [group for group in expected if group["datetime_count"]]
        )
    ...
    def test_with_datetimes_and_groupby_per_hour(self):
        ...
        expected = [
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 01:00:00",
                        "to": "1916-01-01 02:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 02:00:00",
                        "to": "1916-01-01 03:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 03:00:00",
                        "to": "1916-01-01 04:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 04:00:00",
                        "to": "1916-01-01 05:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 05:00:00",
                        "to": "1916-01-01 06:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 06:00:00",
                        "to": "1916-01-01 07:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 07:00:00",
                        "to": "1916-01-01 08:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 08:00:00",
                        "to": "1916-01-01 09:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 09:00:00",
                        "to": "1916-01-01 10:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 10:00:00",
                        "to": "1916-01-01 11:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 11:00:00",
                        "to": "1916-01-01 12:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 12:00:00",
                        "to": "1916-01-01 13:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 13:00:00",
                        "to": "1916-01-01 14:00:00",
                    }
                },
                "datetime:hour": "01:00 01 Jan",
                "datetime_count": 1,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 14:00:00",
                        "to": "1916-01-01 15:00:00",
                    }
                },
                "datetime:hour": "02:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 15:00:00",
                        "to": "1916-01-01 16:00:00",
                    }
                },
                "datetime:hour": "03:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 16:00:00",
                        "to": "1916-01-01 17:00:00",
                    }
                },
                "datetime:hour": "04:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 17:00:00",
                        "to": "1916-01-01 18:00:00",
                    }
                },
                "datetime:hour": "05:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 18:00:00",
                        "to": "1916-01-01 19:00:00",
                    }
                },
                "datetime:hour": "06:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 19:00:00",
                        "to": "1916-01-01 20:00:00",
                    }
                },
                "datetime:hour": "07:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 20:00:00",
                        "to": "1916-01-01 21:00:00",
                    }
                },
                "datetime:hour": "08:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 21:00:00",
                        "to": "1916-01-01 22:00:00",
                    }
                },
                "datetime:hour": "09:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 22:00:00",
                        "to": "1916-01-01 23:00:00",
                    }
                },
                "datetime:hour": "10:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 23:00:00",
                        "to": "1916-01-02 00:00:00",
                    }
                },
                "datetime:hour": "11:00 01 Jan",
                "datetime_count": 1,
        ...
        model_fill = self.Model.with_context(fill_temporal=True)
        groups = model_fill.read_group(
            [], fields=["datetime", "value"], groupby=["datetime:hour"]
        )
        ...
        expected = [
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1915-12-31 22:00:00",
                        "to": "1915-12-31 23:00:00",
                    }
                },
                "datetime:hour": "04:00 01 Jan",
                "datetime_count": 1,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1915-12-31 23:00:00",
                        "to": "1916-01-01 00:00:00",
                    }
                },
                "datetime:hour": "05:00 01 Jan",
                "datetime_count": 0,
            ...
            },
            {
                ...
                "__range": {
                    "datetime:hour": {
                        "from": "1916-01-01 00:00:00",
                        "to": "1916-01-01 01:00:00",
                    }
                },
                "datetime:hour": "06:00 01 Jan",
                "datetime_count": 0,
    ...
    def test_quarter_with_timezones(self):
        ...
        expected = [
            {
                ...
                "__range": {
                    "datetime:quarter": {
                        "from": "2015-12-31 17:00:00",
                        "to": "2016-03-31 16:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:quarter": {
                        "from": "2016-03-31 16:00:00",
                        "to": "2016-06-30 16:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:quarter": {
                        "from": "2016-06-30 16:00:00",
                        "to": "2016-09-30 17:00:00",
                    }
                },
            ...
            },
            {
                ...
                "__range": {
                    "datetime:quarter": {
                        "from": "2016-09-30 17:00:00",
                        "to": "2016-12-31 17:00:00",
                    }
                },
        ...
        model_fill = self.Model.with_context(tz="Asia/Hovd", fill_temporal=True)
        groups = model_fill.read_group(
            [], fields=["datetime", "value"], groupby=["datetime:quarter"]
        )
        ...
        expected = [
            {
                ...
                "__range": {
                    "datetime": {
                        "from": "2017-12-31 17:00:00",
                        "to": "2018-01-31 17:00:00",
                    }
                },
