...
class TestMrpOrder(TestMrpCommon):
    ...
    def test_basic(self):
        ...
        self.assertAlmostEqual(
            ...
            test_date_planned + timedelta(hours=1),
        ...
        self.assertEqual(
            ...
            * self.product_4.uom_id.factor_inv
            * 2,
        )
        first_move = man_order.move_raw_ids.filtered(
        ...
        self.assertEqual(
            len(mo_copy_2.move_raw_ids), 4, "Incorrect number of component moves."
        )
        self.assertEqual(
    ...
    def test_over_consumption(self):
        ...
        details_operation_form = Form(
            mo.move_raw_ids[0], view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.edit(0) as ml:
            ml.qty_done = 2
        details_operation_form.save()
        details_operation_form = Form(
            mo.move_raw_ids[1], view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.edit(0) as ml:
            ml.qty_done = 11
        details_operation_form.save()
    ...
    def test_update_quantity_1(self):
        ...
        self.assertEqual(
            mo.move_raw_ids.filtered(lambda m: m.product_id == p1).quantity_done,
            20,
    ...
    def test_update_quantity_2(self):
        ...
        self.assertEqual(
            sum(
                mo.move_raw_ids.filtered(lambda m: m.product_id == p1).mapped(
                    "quantity_done"
                )
            ),
            20,
    ...
    def test_rounding(self):
        ...
        production = mo_form.save()
        self.assertEqual(
            production.move_raw_ids[0].quantity_done,
            16,
    ...
    def test_product_produce_1(self):
        ...
        self.assertEqual(
            mo_form.move_raw_ids._records[0]["quantity_done"], 3, "Wrong quantity done"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            mo_form.move_raw_ids._records[1]["quantity_done"], 12, "Wrong quantity done"
        )
    ...
    def test_product_produce_3(self):
        ...
        ml_to_shelf_1 = move_1.move_line_ids.filtered(
            lambda ml: ml.lot_id == first_lot_for_p1
            and ml.location_id == self.stock_shelf_1
        )
        ml_to_shelf_2 = move_1.move_line_ids.filtered(
            lambda ml: ml.lot_id == first_lot_for_p1
            and ml.location_id == self.stock_shelf_2
        )
        ...
        self.assertEqual(
            move_1.quantity_done, 13, "You should have used the tem units."
        )
    ...
    def test_product_produce_4(self):
        ...
        mo.action_assign()
        ml_p1 = mo.move_raw_ids.filtered(lambda x: x.product_id == p1).mapped(
            "move_line_ids"
        )
        ml_p2 = mo.move_raw_ids.filtered(lambda x: x.product_id == p2).mapped(
            "move_line_ids"
        )
        ...
        self.assertEqual(
            ...
            [2.0, 3.0],
            "Quantity done should be 1.0, 2.0 or 3.0",
        )
        self.assertEqual(m_p1.quantity_done, 5.0, "Total qty done should be 6.0")
        self.assertEqual(
            sum(ml_p1.mapped("reserved_uom_qty")),
            5.0,
            "Total qty reserved should be 5.0",
        )
    ...
    def test_product_produce_6(self):
        ...
        self.assertEqual(
            sum(mo.move_raw_ids.mapped("move_line_ids.reserved_uom_qty")), 0
        )
    ...
    def test_product_produce_10(self):
        ...
        details_operation_form = Form(
            move_byproduct_1, view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.new() as ml:
        ...
        details_operation_form.save()
        details_operation_form = Form(
            move_byproduct_2, view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.new() as ml:
        ...
        details_operation_form.save()
        details_operation_form = Form(
            move_byproduct_3, view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.edit(0) as ml:
            ml.qty_done = 3
        details_operation_form.save()
    ...
    def test_product_produce_11(self):
        ...
        self.assertEqual(
            ...
            5,
            "Update the produce quantity should not change the components reserved quantity.",
        )
        mo_form = Form(mo)
    ...
    def test_product_produce_duplicate_2(self):
        ...
        mo1 = mo_form.save()
        details_operation_form = Form(
            mo1.move_raw_ids[0], view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.new() as ml:
            ml.lot_id = sn
        details_operation_form.save()
        ...
        mo2 = mo_form.save()
        details_operation_form = Form(
            mo2.move_raw_ids[0], view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.new() as ml:
            ml.lot_id = sn
        details_operation_form.save()
    ...
    def test_product_produce_duplicate_3(self):
        ...
        details_operation_form = Form(
            move_byproduct, view=self.env.ref("stock.view_stock_move_operations")
        )
        with details_operation_form.move_line_ids.new() as ml:
            ml.lot_id = sn
        details_operation_form.save()
    ...
    def test_product_produce_uom(self):
        ...
        mo._post_inventory()
        move_line_finished = mo.move_finished_ids.mapped("move_line_ids").filtered(
            lambda m: m.qty_done
        )
    ...
    def test_immediate_validate_uom_2(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            storable_component, self.env.ref("stock.stock_location_stock"), 100
        )
    ...
    def test_workcenter_timezone(self):
        ...
        self.assertEqual(
            mo.workorder_ids[0].date_planned_finished, date_planned + timedelta(hours=4)
        )
        tuesday = date_planned + timedelta(days=1)
        self.assertEqual(
            mo.workorder_ids[1].date_planned_start, tuesday.replace(hour=1)
        )
        self.assertEqual(
            mo.workorder_ids[1].date_planned_finished, tuesday.replace(hour=2)
        )
    ...
    def test_backorder_with_underconsumption(self):
        ...
        self.assertEqual(mo.product_uom_qty, 10.0)
        self.assertEqual(mo.qty_produced, 10.0)
        move_prod_1_done = mo.move_raw_ids.filtered(
            lambda m: m.product_id == p1 and m.state == "done"
        )
        ...
        move_prod_1_cancel = mo.move_raw_ids.filtered(
    ...
    def test_planning_cancelled_workorder(self):
        ...
        mo.button_plan()
        self.assertEqual(
            mo.workorder_ids[0].date_planned_start, datetime(2023, 3, 1, 12, 0)
        )
        self.assertEqual(
            mo.workorder_ids[1].date_planned_start, datetime(2023, 3, 1, 13, 15)
        )
        self.assertEqual(
            mo.workorder_ids[2].date_planned_start, datetime(2023, 3, 1, 14, 30)
        )
        ...
        self.assertEqual(
            mo_backorder.workorder_ids[1].date_planned_start,
            datetime(2023, 3, 1, 12, 0),
        )
        self.assertEqual(
            mo_backorder.workorder_ids[2].date_planned_start,
            datetime(2023, 3, 1, 12, 45),
        )
