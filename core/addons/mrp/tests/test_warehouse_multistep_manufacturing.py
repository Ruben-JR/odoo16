...
class TestMultistepManufacturingWarehouse(TestMrpCommon):
    ...
    def setUpClass(cls):
        ...
        # Create warehouse
        cls.customer_location = cls.env["ir.model.data"]._xmlid_to_res_id(
    ...
    def test_manufacturing_flow(self):
        ...
        self.assertEqual(
            ...
            "SOURCEDOCUMENT",
            "The post-prod origin should be the SO name",
        )
        ...
        self.assertEqual(
            picking_stock_pick.move_ids.move_orig_ids.picking_id, picking_stock_postprod
        )
    ...
    def test_manufacturing_complex_product_3_steps(self):
        ...
        routes = (
            self.warehouse.manufacture_pull_id.route_id
            + self.warehouse.mto_pull_id.route_id
        )
        ...
        self.assertEqual(
            sfp_pickings.mapped("group_id"), subproduction.procurement_group_id
        )
