...
class StockWarehouse(models.Model):
    ...
    subcontracting_pull_id = fields.Many2one("stock.rule", "Subcontracting MTS Rule")

    subcontracting_route_id = fields.Many2one(
        "stock.route", "Resupply Subcontractor", ondelete="restrict"
    )
