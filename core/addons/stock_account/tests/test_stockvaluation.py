...
class TestStockValuation(TransactionCase):
    ...
    def test_fifo_perpetual_1(self):
        ...
        self.assertEqual(
            move3.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in out move
        self.assertEqual(
            move3.stock_valuation_layer_ids.value, -30.0
        )  # took 3 items from move 1 @ 10.00 per unit
        ...
        self.assertEqual(
            sum(move1.stock_valuation_layer_ids.mapped("remaining_qty")), 9.0
        )
        self.assertEqual(
            sum(move1.stock_valuation_layer_ids.mapped("value")), 120.0
        )  # move 1 is now 10@10 + 2@10
        ...
        self.assertEqual(
            move1_correction_valuation_aml.product_uom_id.id, self.uom_unit.id
        )
        ...
        self.assertEqual(
            move4.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in out move
        self.assertEqual(
            move4.stock_valuation_layer_ids.value, -86.0
        )  # took 9 items from move 1 @ 10.00 per unit
        ...
        self.assertEqual(
            move6.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # already consumed by the next vacuum
        ...
        self.assertEqual(
            move6_correction_valuation_aml.product_uom_id.id, self.uom_unit.id
        )
        ...
        self.assertEqual(
            move6_correction2_valuation_aml.product_id.id, self.product1.id
        )
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 380
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 350
        )
    ...
    def test_fifo_perpetual_2(self):
        ...
        self.assertEqual(
            move7.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in out moves
        ...
        self.assertEqual(
            move8.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in internal moves
        ...
        self.assertEqual(
            move9.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in out moves
    ...
    def test_fifo_perpetual_3(self):
        ...
        self.assertEqual(
            move5.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in out moves
    ...
    def test_fifo_perpetual_4(self):
        ...
        stock_return_picking_form = Form(
            self.env["stock.return.picking"].with_context(
                active_ids=out_pick.ids,
                active_id=out_pick.ids[0],
        ...
        self.assertAlmostEqual(
            return_pick.move_ids.stock_valuation_layer_ids.unit_cost, 11.2
        )
    ...
    def test_fifo_negative_1(self):
        ...
        self.assertEqual(
            move1.stock_valuation_layer_ids.remaining_qty, -50.0
        ...
        self.assertEqual(
            sum(move1.stock_valuation_layer_ids.mapped("value")), -850.0
        )  # 40@15 + 10@25
        self.assertEqual(
            sum(move1.stock_valuation_layer_ids.mapped("remaining_qty")), 0.0
        )
        self.assertEqual(sum(move2.stock_valuation_layer_ids.mapped("value")), 600.0)
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("remaining_qty")), 0.0
        )
        self.assertEqual(sum(move3.stock_valuation_layer_ids.mapped("value")), 500.0)
        self.assertEqual(
            sum(move3.stock_valuation_layer_ids.mapped("remaining_qty")), 10.0
        )
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 1100
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 850
        )
    ...
    def test_fifo_negative_2(self):
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 100
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 120
        )
        ...
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("remaining_qty")), 0
        )
        ...
        self.assertEqual(len(move2.account_move_ids), 1)
        self.assertEqual(
            len(move3.account_move_ids), 1
        )  # the created account move is due to the receipt
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 120
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 120
        )
    ...
    def test_fifo_negative_3(self):
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 310
        )
    ...
    def test_fifo_add_move_in_done_picking_1(self):
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 300
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 0
        )
        ...
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("value")), 220.0
        )  # after correction, the move should be valued at 11@20
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("remaining_qty")), 11.0
        )
        self.assertEqual(move2.stock_valuation_layer_ids.sorted()[-1].unit_cost, 20.0)

        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 320
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 0
        )
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 220
        )
    ...
    def test_fifo_add_moveline_in_done_move_1(self):
        ...
        self.assertEqual(
            sum(move1.stock_valuation_layer_ids.mapped("remaining_qty")), 20.0
        )
        self.assertEqual(move1.stock_valuation_layer_ids.sorted()[-1].unit_cost, 10.0)
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 200
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 0
        )
    ...
    def test_fifo_edit_done_move1(self):
        ...
        move3_valuation_aml = valuation_aml[-1]
        self.assertEqual(
            move3_valuation_aml.debit, 0
        )  # FIXME sle shiiiiiiieeeeet with_context out move doesn't work?
        output_aml = self._get_stock_output_move_lines()
        move3_output_aml = output_aml[-1]
        ...
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("debit")), 220
        )
        self.assertEqual(
            sum(self._get_stock_valuation_move_lines().mapped("credit")), 148
        )
    ...
    def test_fifo_edit_done_move2(self):
        ...
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("value")), -80.0
        )  # the move actually sent 8@10

        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 2
        )
        ...
        self.assertEqual(
            sum(move2.stock_valuation_layer_ids.mapped("value")), -100.0
        )  # the move actually sent 10@10
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 0
        )
    ...
    def test_average_negative_2(self):
        ...
        move1._action_done()
        self.assertEqual(
            move1.stock_valuation_layer_ids.value, -990.0
        )  # as no move out were done for this product, fallback on the standard price
    ...
    def test_average_negative_3(self):
        ...
        self.assertEqual(move2.stock_valuation_layer_ids.value, -100.0)
        self.assertEqual(
            move2.stock_valuation_layer_ids.remaining_qty, 0.0
        )  # unused in average move
        ...
        self.assertEqual(
            move3.stock_valuation_layer_ids.value, -100.0
        )  # as no move out were done for this product, fallback on latest cost
    ...
    def test_average_automated_with_cost_change(self):
        ...
        self.assertAlmostEqual(
            self.product1.stock_valuation_layer_ids.sorted()[-1].value, 900.0
        )
        self.assertAlmostEqual(self.product1.value_svl, 0.0)
    ...
    def test_at_date_standard_1(self):
        ...
        self.product1.stock_valuation_layer_ids.sorted()[-1]._write(
            {"create_date": date5}
        )
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date1)).quantity_svl,
            0,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).quantity_svl,
            10,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).quantity_svl,
            30,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).quantity_svl,
            15,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).quantity_svl,
            15,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date6)).quantity_svl,
            5,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date7)).quantity_svl,
            5,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date8)).quantity_svl,
            95,
        )

        # Valuation at date
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date1)).value_svl, 0
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).value_svl, 100
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).value_svl, 300
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).value_svl, 150
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).value_svl, 75
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date6)).value_svl, 25
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date8)).value_svl,
            712.5,
        )
    ...
    def test_at_date_fifo_1(self):
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date1)).value_svl, 100
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).quantity_svl,
            20,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).value_svl, 220
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).quantity_svl,
            5,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).value_svl, 60
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).quantity_svl,
            -15,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).value_svl,
            -180,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).quantity_svl,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).value_svl,
            1320,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date6)).quantity_svl,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date6)).value_svl,
            1275,
        )
        self.assertEqual(self.product1.quantity_svl, 95)
    ...
    def test_at_date_fifo_2(self):
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).value_svl, 250
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).quantity_svl,
            -10,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date3)).value_svl,
            -150,
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).quantity_svl,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date4)).value_svl, 0
        )
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).quantity_svl,
            10,
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date5)).value_svl, 100
        )
        self.assertEqual(self.product1.quantity_svl, 10)
        self.assertEqual(self.product1.value_svl, 100)
    ...
    def test_at_date_average_1(self):
        ...
        self.assertEqual(
            self.product1.with_context(to_date=Datetime.to_string(date2)).value_svl, 50
        )
    ...
    def test_forecast_report_value(self):
        ...
        report_value_1 = report_for_company_1.get_report_values(
            docids=self.product1.ids
        )
        report_value_2 = report_for_company_2.get_report_values(
            docids=self.product1.ids
        )
    ...
    def test_fifo_and_sml_owned_by_company(self):
        ...
        self.assertEqual(
            move.stock_valuation_layer_ids.account_move_id.amount_total, 10
        )
