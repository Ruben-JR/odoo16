...
class TestPERF(common.TransactionCase):
    ...
    @users("admin")
    @warmup
    def ___test_complex_sales_orders_batch_creation_perf_with_discount_computation(
        self,
    ):
        ...
        vals_list = [
            {
                ...
                "order_line": [(0, 0, {"display_type": "line_note", "name": "NOTE"})]
        ...
        vals_list = [
            {
                ...
                + [
                    (
                        0,
                        0,
                        {"product_id": product.id, "product_uom_qty": random.random()},
                    )
