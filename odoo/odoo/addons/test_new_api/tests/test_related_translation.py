...
class TestRelatedTranslation(odoo.tests.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.test1 = (
            cls.env["test_new_api.related_translation_1"]
        ...
        cls.test2 = (
            cls.env["test_new_api.related_translation_2"]
            .with_context(lang="en_US")
            .create(
                {
        ...
        cls.test3 = (
            cls.env["test_new_api.related_translation_3"]
            .with_context(lang="en_US")
            .create(
                {
    ...
    def test_translate_from_ori_term(self):
        ...
        self.test1.update_field_translations(
            "html", {"fr_FR": {"Couteau": "Nouveau couteau"}}
        )
        self.assertEqual(
            self.test1.with_context(lang="en_US").html,
            "<p>Knife</p><p>Fork</p><p>Spoon</p>",
