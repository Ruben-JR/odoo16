...
class SaleOrderLine(models.Model):
    ...
    @api.depends(
        "move_ids", "move_ids.stock_valuation_layer_ids", "move_ids.picking_id.state"
    )
    def _compute_purchase_price(self):
        ...
        for line in self:
            ...
            if not line.move_ids:
                ...
                purch_price = product._compute_average_price(
