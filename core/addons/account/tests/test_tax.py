...
class TestTaxCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.company_data_2 = cls.setup_company_data(
            "company_2", currency_id=cls.currency_no_decimal.id
        )
...
class TestTax(TestTaxCommon):
    ...
    def test_tax_group_percent(self):
        res = self.group_tax_percent.with_context(
    ...
    def test_rounding_tax_excluded_round_per_line_01(self):
        ...
        self.tax_19_percent.company_id.tax_calculation_rounding_method = (
            "round_per_line"
        )
    ...
    def test_rounding_tax_included_round_per_line_03(self):
        ...
        res1 = (self.tax_8_percent | self.tax_0_percent).compute_all(
            15.55, quantity=8.0
        )
        self._check_compute_all_results(
        ...
        res2 = (self.tax_0_percent | self.tax_8_percent).compute_all(
            15.55, quantity=8.0
        )
        self._check_compute_all_results(
            124.40,  # 'total_included'
    ...
    def test_rounding_tax_included_round_globally_02(self):
        ...
        self.tax_21_percent.company_id.tax_calculation_rounding_method = (
            "round_globally"
        )
    ...
    def test_is_base_affected(self):
        ...
        tax_ids_list = [
            tax_line["tax_ids"] for tax_line in compute_all_results["taxes"]
        ]
        self.assertEqual(
            tax_ids_list,
            expected_tax_ids_list,
            "Only a tax affected by previous taxes should have tax_ids set on its tax line when used after an 'include_base_amount' tax.",
        )
