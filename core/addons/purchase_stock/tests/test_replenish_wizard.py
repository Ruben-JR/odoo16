...
class TestReplenishWizard(TestStockCommon):
        ...
        cls.product1 = cls.env["product.product"].create(
            {
                ...
                "route_ids": [
                    (4, cls.env.ref("purchase_stock.route_warehouse0_buy").id, 0)
                ],
            }
        )
    ...
    def test_replenish_buy_1(self):
        ...
        self.assertEqual(
            order_line.price_unit, self.product1_price, "Prices does not match"
        )
        ...
        product_to_buy = self.env["product.product"].create(
            {
                ...
                "route_ids": [
                    (4, self.env.ref("purchase_stock.route_warehouse0_buy").id, 0)
                ],
            }
        )
