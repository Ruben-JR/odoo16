...
class TestPurchaseOrder(ValuationReconciliationTestCommon):
    ...
    def test_00_purchase_order_flow(self):
        ...
        self.assertEqual(
            self.po.order_line.mapped("qty_invoiced"),
            [0.0, 0.0],
        ...
        self.assertEqual(
            self.po.incoming_picking_count,
            1,
    ...
    def test_04_multi_uom(self):
        ...
        self.assertEqual(
            po.order_line.mapped("qty_received"),
            [4.0],
    ...
    def test_message_qty_already_received(self):
        ...
        self.assertIsNotNone(
            re.search(r"Received Quantity: 5.0 -&gt; 10.0", _message_content),
            "Already received quantity isn't correctly taken into consideration",
        )
    ...
    def test_packaging_propagation(self):
        ...
        packOf10 = self.env["product.packaging"].create(
            {"name": "PackOf10", "product_id": self.product_a.id, "qty": 10}
        )

        packOf20 = self.env["product.packaging"].create(
            {"name": "PackOf20", "product_id": self.product_a.id, "qty": 20}
        )
