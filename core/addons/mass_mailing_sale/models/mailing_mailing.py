...
class MassMailing(models.Model):
    ...
    def _compute_sale_quotation_count(self):
        ...
        mapped_data = {
            datum["source_id"][0]: datum["source_id_count"] for datum in quotation_data
        }
    ...
    def _compute_sale_invoiced_amount(self):
        ...
        moves_data = (
            ...
            ._read_group(
                domain,
                ["source_id", "amount_untaxed_signed"],
                ["source_id"],
            )
        )
        mapped_data = {
            datum["source_id"][0]: datum["amount_untaxed_signed"]
            for datum in moves_data
        }
        for mass_mailing in self:
    ...
    def _prepare_statistics_email_values(self):
        ...
        formated_amount = tools.format_decimalized_amount(
