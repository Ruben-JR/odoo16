...
class ChangeProductionQty(models.TransientModel):
    ...
    product_qty = fields.Float(
        "Quantity To Produce", digits="Product Unit of Measure", required=True
    )
    ...
    def _need_quantity_propagation(self, move, qty):
        return move.move_dest_ids and not float_is_zero(
    ...
    def change_prod_qty(self):
        ...
        for wizard in self:
            ...
            factor = (new_production_qty - qty_produced) / (
                old_production_qty - qty_produced
            )
            ...
            self._update_finished_moves(
                production,
                new_production_qty - qty_produced,
                old_production_qty - qty_produced,
            )
