...
safe_attrs = clean.defs.safe_attrs | frozenset(
    [
        ...
        "data-behavior-props",
        "data-prop-name",  # knowledge commands
    ]
)
SANITIZE_TAGS = {
    # allow new semantic HTML5 tags
    "allow_tags": clean.defs.tags
    | frozenset(
...
def tag_quote(el):
    ...
    if (
        "gmail_extra" in el_class
        or "divRplyFwdMsg" in el_id
...
def append_content_to_html(
    html, content, plaintext=True, preserve=False, container_tag=None
):
