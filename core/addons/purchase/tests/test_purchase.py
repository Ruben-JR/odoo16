...
class TestPurchase(AccountTestInvoicingCommon):
    def test_date_planned(self):
        ...
        self.assertAlmostEqual(
            po.order_line[0].date_planned,
            po.order_line[1].date_planned,
            delta=timedelta(seconds=10),
        )
        self.assertAlmostEqual(
            po.order_line[0].date_planned, po.date_planned, delta=timedelta(seconds=10)
        )
        ...
        self.assertAlmostEqual(
            po.order_line[1].date_planned, po.date_planned, delta=timedelta(seconds=10)
        )
    ...
    def test_unit_price_precision_multicurrency(self):
        ...
        self.assertEqual(
            purchase_order_usd.order_line.price_unit,
        ...
        self.assertEqual(
            purchase_order_coco.order_line.price_unit,
    ...
    def test_purchase_not_creating_useless_product_vendor(self):
        ...
        self.assertEqual(
            po.order_line.product_id.seller_ids.mapped("partner_id"), delivery_address
        )
