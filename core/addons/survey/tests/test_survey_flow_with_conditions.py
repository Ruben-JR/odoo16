    ...
    def test_conditional_flow_with_scoring(self):
        with self.with_user("survey_user"):
            ...
            q02 = self._add_question(
                ...
                survey_id=survey.id,
                is_conditional=True,
                triggering_question_id=q01.id,
                triggering_answer_id=q01.suggested_answer_ids.filtered(
            ...
            self._add_question(  # q04
                ...
                survey_id=survey.id,
                is_conditional=True,
                triggering_question_id=q03.id,
                triggering_answer_id=q03.suggested_answer_ids.filtered(
                    lambda q: q.is_correct
                ).id,
                labels=[
                    {"value": "Answer 1"},
            ...
            q06 = self._add_question(
                ...
                survey_id=survey.id,
                is_conditional=True,
                triggering_question_id=q05.id,
                triggering_answer_id=q05.suggested_answer_ids.filtered(
                    lambda q: q.is_correct
                ).id,
                labels=[
                    {"value": "Answer 1"},
        ...
        self.assertEqual(
            ...
            60,
            "Three right answers out of five (the fourth one is still hidden)",
        )
