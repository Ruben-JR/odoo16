        ...
        self.action.write(
            {
                ...
                "fields_lines": [
                    Command.create(
                        {"col1": self.res_partner_name_field.id, "value": _name}
                    ),
                    Command.create(
                        {"col1": self.res_partner_city_field.id, "value": _city}
                    ),
                ],
            }
        )
        ...
        self.action.write(
            {
                ...
                "fields_lines": [
                    Command.create(
                        {
                            "col1": self.res_partner_category_name_field.id,
                            "value": "record.name",
                            "evaluation_type": "equation",
                        }
                    )
        ...
        action2 = self.action.create(
            {
                ...
                "fields_lines": [
                    Command.create(
                        {
                            "col1": self.res_partner_name_field.id,
                            "value": "RaoulettePoiluchette",
                        }
                    ),
                    Command.create(
                        {"col1": self.res_partner_city_field.id, "value": "TestingCity"}
                    ),
                ],
            }
        )
