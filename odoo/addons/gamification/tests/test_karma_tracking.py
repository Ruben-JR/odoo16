...
class TestKarmaTrackingCommon(common.TransactionCase):
    ...
    def test_consolidation_cron(self):
        self.patcher = patch(
            "odoo.addons.gamification.models.gamification_karma_tracking.fields.Date",
            wraps=fields.Date,
        )
        self.mock_datetime = self.startPatcher(self.patcher)
        self.mock_datetime.today.return_value = date(
            self.test_date.year, self.test_date.month + 1, self.test_date.day
        )
    ...
    def test_consolidation_monthly(self):
        ...
        self.assertEqual(
            consolidated.old_value, base_test_user_2_karma
        ...
        self.assertEqual(
            consolidated[0].tracking_date, self.test_date + relativedelta(months=1)
...
class TestComputeRankCommon(common.TransactionCase):
    ...
    def test_02_update_rank_without_switch(self):
        ...
        patch_bulk = patch(
            "odoo.addons.gamification.models.res_users.Users._recompute_rank",
    ...
    def test_03_test_bulk_call(self):
        ...
        patch_bulk = patch(
            "odoo.addons.gamification.models.res_users.Users._recompute_rank_bulk",
