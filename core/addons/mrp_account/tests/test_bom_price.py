...
class TestBomPrice(TestBomPriceCommon):
    ...
    def test_01_compute_price_operation_cost(self):
        ...
        self.assertEqual(
            ...
            856.25,
            "After computing price from BoM price should be 856.25",
        )
        self.Product.browse(
        ...
        self.assertEqual(
            float_compare(
                self.dining_table.standard_price, 1050.52, precision_digits=2
            ),
            0,
            "After computing price from BoM price should be 1050.52",
        )
