...
class MrpStockReport(models.TransientModel):
    ...
    @api.model
    def _lines(
        self, line_id=None, model_id=False, model=False, level=0, move_lines=[], **kw
    ):
        final_vals = []
        lines = move_lines or []
    ...
    def get_pdf(self, line_data=None):
        ...
        return self.env["ir.actions.report"]._run_wkhtmltopdf(
            ...
            specific_paperformat_args={
                "data-report-margin-top": 17,
                "data-report-header-spacing": 12,
            },
        )
    ...
    def _get_html(self):
        ...
        result["html"] = self.env["ir.qweb"]._render(
            "stock.report_stock_inventory", rcontext
        )
        return result
