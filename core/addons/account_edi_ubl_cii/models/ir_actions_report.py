...
class IrActionsReport(models.Model):
    ...
    def _add_pdf_into_invoice_xml(self, invoice, stream_data):
        ...
        edi_attachments = (
            invoice.edi_document_ids.filtered(
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if (
            ...
            in ("account.report_invoice_with_payments", "account.report_invoice")
        ):
            ...
            if len(res_ids) == 1:
                ...
                if (
                    ...
                    xml_content, _errors = self.env[
                        "account.edi.xml.cii"
                    ]._export_invoice(invoice)
                    writer.addAttachment(
                        name=self.env["account.edi.xml.cii"]._export_invoice_filename(
                            invoice
                        ),
                        data=xml_content,
                        subtype="text/xml",
