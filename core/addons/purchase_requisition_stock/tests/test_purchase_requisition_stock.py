...
class TestPurchaseRequisitionStock(TestPurchaseRequisitionCommon):
    def test_02_purchase_requisition_stock(self):
        ...
        self.assertEqual(
            purchase1.order_line.price_unit,
            50,
        ...
        line1 = (
            ...
            0,
            {
                "product_id": product_test.id,
                "product_qty": 18,
                "product_uom_id": product_test.uom_po_id.id,
                "price_unit": 50,
            },
        )
        ...
        self.assertEqual(
            purchase2.order_line.price_unit,
            50,
    ...
    def test_03_purchase_requisition_stock(self):
        ...
        line1 = (
            ...
            0,
            {
                ...
                "product_qty": 18,
                "product_uom_id": product_1.uom_po_id.id,
                "price_unit": 41,
            },
        )
        line2 = (
    ...
    def test_04_purchase_requisition_stock(self):
        ...
        self.assertEqual(
            orig_po.order_line.product_id,
            alt_po.order_line.product_id,
            "Alternative PO should have copied the product to purchase from original PO",
        )
        self.assertEqual(
            orig_po.order_line.product_qty,
            alt_po.order_line.product_qty,
