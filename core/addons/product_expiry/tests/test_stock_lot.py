...
class TestStockLot(TestStockCommon):
    ...
    def test_01_stock_production_lot(self):
        ...
        self.productBBB = self.ProductObj.create(
            {"name": "Product BBB", "type": "product", "tracking": "lot"}
        )
    ...
    def test_02_stock_production_lot(self):
        ...
        self.productCCC = self.ProductObj.create(
            {"name": "Product CCC", "type": "product", "tracking": "lot"}
        )

        # create a new lot with with alert date in the past
        self.lot1_productCCC = self.LotObj.create(
            {
                "name": "Lot 1 ProductCCC",
    ...
    def test_04_expiration_date_on_receipt(self):
        ...
        move_form = Form(
            receipt.move_ids_without_package, view="stock.view_stock_move_operations"
        )
    ...
    def test_apply_lot_without_date_on_sml(self):
        ...
        self.assertAlmostEqual(lot.expiration_date, exp_date, delta=time_gap)
        self.assertAlmostEqual(
            lot.use_date,
