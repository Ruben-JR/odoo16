...
class TestQwebFieldTime(common.TransactionCase):
    ...
    def test_time_value_to_html(self):
        self.assertEqual(self.value_to_html(0), "12:00 AM")

        self.assertEqual(self.value_to_html(11.75), "11:45 AM")

        self.assertEqual(self.value_to_html(12), "12:00 PM")

        self.assertEqual(self.value_to_html(14.25), "2:15 PM")
...
class TestQwebFieldInteger(common.TransactionCase):
    ...
    def test_integer_value_to_html(self):
        ...
        self.assertEqual(
            self.value_to_html(1000000, {"format_decimalized_number": True}), "1M"
        )
        self.assertEqual(
            self.value_to_html(
                125125, {"format_decimalized_number": True, "precision_digits": 3}
            ),
            "125.125k",
        )
