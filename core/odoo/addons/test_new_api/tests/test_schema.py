...
class TestReflection(common.TransactionCase):
    ...
    def assertSelectionXID(self, record):
        ...
        xid = selection_xmlid(
            "test_new_api", record.field_id.model, record.field_id.name, record.value
        )
        self.assertEqual(record, self.env.ref(xid))
    ...
    def test_models_fields(self):
        ...
        model_names = {
            get_model_name(cls) for cls in MetaModel.module_to_models["test_new_api"]
        }
        ...
        for ir_model in ir_models:
            with self.subTest(model=ir_model.model):
                ...
                self.assertItemsEqual(
                    ir_model.mapped("field_id.name"), list(model._fields)
                )
                for ir_field in ir_model.field_id:
                    with self.subTest(field=ir_field.name):
                        ...
                        self.assertEqual(
                            ir_field.selectable, bool(field.search or field.store)
                        )
...
class TestSchema(common.TransactionCase):
    ...
    def test_10_boolean(self):
        ...
        self.assertEqual(
            columns_data["important"],
            {
                ...
                "numeric_scale": None,
                "table_catalog": self.cr.dbname,
                "table_name": "test_new_api_message",
                "table_schema": "public",
    ...
    def test_10_integer(self):
        ...
        self.assertEqual(
            columns_data["color"],
            {
                ...
                "numeric_scale": 0,
                "table_catalog": self.cr.dbname,
                "table_name": "test_new_api_category",
                "table_schema": "public",
                "udt_catalog": self.cr.dbname,
                "udt_name": "int4",
                "udt_schema": "pg_catalog",
    ...
    def test_10_datetime(self):
        ...
        columns_data = self.get_columns_data(model._table)
        self.assertEqual(
            columns_data["value_datetime"],
            {
                "character_maximum_length": None,
                "column_default": None,
                "column_name": "value_datetime",
    ...
    def test_10_many2many(self):
        ...
        self.assertEqual(
            table_data,
            {
                ...
                "is_typed": "NO",
                "table_catalog": self.cr.dbname,
                "table_name": "test_new_api_discussion_category",
                "table_schema": "public",
                "table_type": "BASE TABLE",
                "user_defined_type_catalog": None,
                "user_defined_type_name": None,
