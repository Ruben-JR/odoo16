...
class TestFifoReturns(ValuationReconciliationTestCommon):
    def test_fifo_returns(self):
        ...
        return_picking_id, dummy = return_pick_wiz.with_context(
        ...
        return_picking.move_ids[0].quantity_done = return_picking.move_ids[
            0
        ].product_uom_qty
        ...
        self.assertEqual(
            product_fiforet_icecream.qty_available, 10.0, "Qty available should be 10.0"
        )
        self.assertEqual(
