...
class AccountChartTemplate(models.Model):
    ...
    def generate_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        return super(AccountChartTemplate, self).generate_journals(
    ...
    def generate_properties(self, acc_template_ref, company, property_list=None):
        ...
        if value:
            PropertyObj._set_default(
                "property_stock_journal", "product.category", value, company
            )
        ...
        categ_values = {
            category.id: False for category in self.env["product.category"].search([])
        }
