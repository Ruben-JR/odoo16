...
class TestBomPrice(TestBomPriceCommon):
    def test_00_compute_price(self):
        ...
        self.assertEqual(
            self.dining_table.standard_price,
            550,
            "After computing price from BoM price should be 550",
        )
    ...
    def test_01_compute_price_operation_cost(self):
        ...
        self.assertEqual(
            ...
            871.25,
            "After computing price from BoM price should be 871.25",
        )
        self.Product.browse(
        ...
        self.assertEqual(
            float_compare(
                self.dining_table.standard_price, 1065.52, precision_digits=2
            ),
            0,
            "After computing price from BoM price should be 1065.52",
        )
    ...
    def test_02_compute_byproduct_price(self):
        ...
        self.assertEqual(
            self.dining_table.standard_price,
            137.5,
            "After computing price from BoM price should be 137.5",
        )
