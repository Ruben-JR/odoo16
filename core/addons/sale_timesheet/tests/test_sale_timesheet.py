...
class TestSaleTimesheet(TestCommonSaleTimesheet):
    ...
    def test_timesheet_order(self):
        ...
        self.assertEqual(
            ...
            project_serv1.analytic_account_id,
        ...
        self.assertEqual(
            so_line_ordered_global_project.qty_delivered,
            10.5,
        ...
        self.assertEqual(
            so_line_ordered_project_only.qty_delivered,
            0.0,
            "Timesheet directly on project does not increase delivered quantity on so line",
        )
        self.assertEqual(
    ...
    def test_timesheet_delivery(self):
        ...
        self.assertEqual(
            sale_order.analytic_account_id,
            project_serv2.analytic_account_id,
            "The created project should be linked to the analytic account of the SO",
        )
        ...
        self.assertEqual(
            so_line_deliver_task_project.invoice_status,
            "no",
        ...
        self.assertTrue(
            float_is_zero(
                so_line_deliver_only_project.qty_delivered, precision_digits=2
            ),
    ...
    def test_timesheet_manual(self):
        ...
        self.assertTrue(
            float_is_zero(
                so_line_manual_global_project.qty_delivered, precision_digits=2
            ),
...
class TestSaleTimesheetView(TestCommonTimesheet):
    def test_get_view_timesheet_encode_uom(self):
        ...
        self.assert_get_view_timesheet_encode_uom(
            [
                (
                    "sale_timesheet.project_project_view_form",
                    '//field[@name="display_cost"]',
                    [None, "Daily Cost"],
                ),
            ]
        )
