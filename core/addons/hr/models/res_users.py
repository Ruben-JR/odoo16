...
class User(models.Model):
    ...
    job_title = fields.Char(
        related="employee_id.job_title", readonly=False, related_sudo=False
    )
    ...
    employee_phone = fields.Char(
        related="employee_id.phone", readonly=False, related_sudo=False
    )
    ...
    department_id = fields.Many2one(
        related="employee_id.department_id", readonly=False, related_sudo=False
    )
    address_id = fields.Many2one(
        related="employee_id.address_id", readonly=False, related_sudo=False
    )
    work_location_id = fields.Many2one(
        related="employee_id.work_location_id", readonly=False, related_sudo=False
    )
    employee_parent_id = fields.Many2one(
        related="employee_id.parent_id", readonly=False, related_sudo=False
    )
    coach_id = fields.Many2one(
        related="employee_id.coach_id", readonly=False, related_sudo=False
    )
    address_home_id = fields.Many2one(
        related="employee_id.address_home_id", readonly=False, related_sudo=False
    )
    ...
    private_email = fields.Char(
        related="address_home_id.email", string="Private Email", readonly=False
    )
    private_lang = fields.Selection(
        related="address_home_id.lang", string="Employee Lang", readonly=False
    )
    ...
    employee_country_id = fields.Many2one(
    ...
    identification_id = fields.Char(
        related="employee_id.identification_id", readonly=False, related_sudo=False
    )
    passport_id = fields.Char(
        related="employee_id.passport_id", readonly=False, related_sudo=False
    )
    gender = fields.Selection(
        related="employee_id.gender", readonly=False, related_sudo=False
    )
    ...
    visa_no = fields.Char(
        related="employee_id.visa_no", readonly=False, related_sudo=False
    )
    permit_no = fields.Char(
        related="employee_id.permit_no", readonly=False, related_sudo=False
    )
    ...
    certificate = fields.Selection(
        related="employee_id.certificate", readonly=False, related_sudo=False
    )
    study_field = fields.Char(
        related="employee_id.study_field", readonly=False, related_sudo=False
    )
    study_school = fields.Char(
        related="employee_id.study_school", readonly=False, related_sudo=False
    )
    ...
    employee_type = fields.Selection(
        related="employee_id.employee_type", readonly=False, related_sudo=False
    )
    ...
    def write(self, vals):
        ...
        if hr_fields and not can_edit_self:
            ...
            raise AccessError(
                _(
                    "You are only allowed to update your preferences. Please contact a HR officer to update other information."
                )
            )
        ...
        if employee_values:
            ...
            if "image_1920" in vals:
                without_image = (
                    ...
                    .sudo()
                    .search([("user_id", "in", self.ids), ("image_1920", "=", False)])
                )
                with_image = (
                    self.env["hr.employee"]
                    .sudo()
