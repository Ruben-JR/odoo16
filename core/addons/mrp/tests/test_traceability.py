...
class TestTraceability(TestMrpCommon):
    ...
    def test_tracking_on_byproducts(self):
        ...
        self.assertEqual(
            finished_move_line_lot_1.consume_line_ids.filtered(lambda l: l.qty_done),
        ...
        self.assertEqual(
            byproduct_move_line_1_lot_1.consume_line_ids.filtered(lambda l: l.qty_done),
            raw_line_raw_1_lot_1 | raw_line_raw_2_lot_1,
        )
        ...
        self.assertEqual(
            byproduct_move_line_2_lot_1.consume_line_ids.filtered(lambda l: l.qty_done),
            raw_line_raw_1_lot_1 | raw_line_raw_2_lot_1,
        )
    ...
    def test_tracked_and_manufactured_component(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            productB, stock_location, 10, lot_id=lot_B01
        )
        self.env["stock.quant"]._update_available_quantity(
            productB, stock_location, 5, lot_id=lot_B02
        )
    ...
    def test_last_delivery_traceability(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            subcomponentA, stock_location, 1, lot_id=lot_subcomponentA
        )
    ...
    def test_unbuild_scrap_and_unscrap_tracked_component(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            component, stock_location, 1, lot_id=serial_number
        )
