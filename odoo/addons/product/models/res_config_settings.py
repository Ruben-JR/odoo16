...
class ResConfigSettings(models.TransientModel):
    ...
    group_discount_per_so_line = fields.Boolean(
        "Discounts", implied_group="product.group_discount_per_so_line"
    )
    group_uom = fields.Boolean("Units of Measure", implied_group="uom.group_uom")
    group_product_variant = fields.Boolean(
        "Variants", implied_group="product.group_product_variant"
    )
    ...
    group_stock_packaging = fields.Boolean(
        "Product Packagings", implied_group="product.group_stock_packaging"
    )
    group_product_pricelist = fields.Boolean(
        "Pricelists", implied_group="product.group_product_pricelist"
    )
    ...
    product_pricelist_setting = fields.Selection(
        ...
        config_parameter="product.product_pricelist_setting",
