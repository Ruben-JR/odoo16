...
class AlipayController(http.Controller):
    ...
    def alipay_return_from_checkout(self, **data):
        ...
        """
        _logger.info(
            "handling redirection from Alipay with data:\n%s", pprint.pformat(data)
        )
        ...
        tx_sudo = (
            ...
            .sudo()
            ._get_tx_from_notification_data("alipay", data)
        )
    ...
    def alipay_webhook(self, **data):
        ...
        """
        _logger.info(
            "notification received from Alipay with data:\n%s", pprint.pformat(data)
        )
        try:
    ...
    def _verify_notification_signature(notification_data, tx_sudo):
        ...
        expected_signature = tx_sudo.provider_id._alipay_compute_signature(
            notification_data
        )
