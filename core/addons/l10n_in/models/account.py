...
class AccountJournal(models.Model):
    ...
    def name_get(self):
        ...
        indian_journals = self.filtered(
            lambda j: j.company_id.account_fiscal_country_id.code == "IN"
            and j.l10n_in_gstin_partner_id
            and j.l10n_in_gstin_partner_id.vat
        )
...
class AccountMoveLine(models.Model):
    ...
    def _compute_tax_base_amount(self):
        aml = self.filtered(
            lambda l: l.company_id.account_fiscal_country_id.code == "IN"
            and l.tax_line_id
            and l.product_id
        )
...
class AccountTax(models.Model):
    ...
    def _get_generation_dict_from_base_line(
        ...
        res = super()._get_generation_dict_from_base_line(
            line_vals, tax_vals, force_caba_exigibility=force_caba_exigibility
        )
