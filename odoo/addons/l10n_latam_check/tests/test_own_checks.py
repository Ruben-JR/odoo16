    ...
    def test_01_pay_with_manual_check(self):
        ...
        with Form(
            ...
            payment_form.payment_method_line_id = (
                self.bank_journal._get_available_payment_method_lines(
                    "outbound"
                ).filtered(lambda x: x.code == "check_printing")
            )

            payment_form.ref = "Deferred check"
            payment_form.l10n_latam_check_payment_date = fields.Date.add(
