...
class TestAr(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref="l10n_ar.l10nar_ri_chart_template"):
        ...
        # ==== Company MONO ====
        cls.company_mono = cls.setup_company_data(
            "(AR) Monotributista (Unit Tests)",
            chart_template=cls.env.ref("l10n_ar.l10nar_base_chart_template"),
        )["company"]
    ...
    def _create_test_invoices_like_demo(self, use_current_date=True):
        ...
        invoices_to_create = {
            "test_invoice_1": {
                ...
                "invoice_line_ids": [{"product_id": self.service_iva_21}],
            },
            "test_invoice_2": {
            ...
            "test_invoice_3": {
                ...
                "invoice_line_ids": [
                    ...
                    {
                        "product_id": self.product_iva_cero,
                        "price_unit": 200.0,
                        "quantity": 1,
                    },
                ],
    ...
    def _create_journal(self, afip_ws, data=None):
        ...
        values = {
            ...
            "type": "sale",
            "code": afip_ws,
            "l10n_ar_afip_pos_system": self._get_afip_pos_system_real_name().get(
                afip_ws
            ),
        ...
        _logger.info(
            "Created journal %s for company %s", journal.name, self.env.company.name
        )
        return journal
    ...
    def _create_debit_note(self, invoice, data=None):
        ...
        debit_note_wizard = (
            ...
            .create({"reason": data.get("reason", "Mercadería defectuosa")})
        )
            ...
            .search(
                [
                    ...
                    (
                        "tax_group_id",
                        "=",
                        self.env.ref("l10n_ar.tax_group_" + tax_type).id,
                    ),
                ],
                limit=1,
            )
