...
class TestAccountPaymentRegister(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.payment_debit_account_id = cls.company_data[
            "default_journal_bank"
        ].company_id.account_journal_payment_debit_account_id.copy()
        cls.payment_credit_account_id = cls.company_data[
            "default_journal_bank"
        ].company_id.account_journal_payment_credit_account_id.copy()
    ...
    def test_register_payment_single_batch_grouped_keep_open_lower_amount(self):
        ...
        self.assertRecordValues(
            payments.line_ids.sorted("balance"),
            [
                # Receivable line:
                {
                    "debit": 0.0,
    ...
    def test_register_payment_single_batch_not_grouped(self):
        ...
        self.assertRecordValues(
            payments[0].line_ids.sorted("balance")
            + payments[1].line_ids.sorted("balance"),
            [
    ...
    def test_register_payment_multiple_batch_grouped_with_credit_note(self):
        ...
        self.assertRecordValues(
            payments[0].line_ids.sorted("balance")
            + payments[1].line_ids.sorted("balance")
            + payments[2].line_ids.sorted("balance"),
            [
                # Liquidity line:
                {
                    "debit": 0.0,
    ...
    def test_register_payment_multi_batches_grouped(self):
        ...
        self.assertRecordValues(payment_register, [{"payment_difference": 0.0}])
    ...
    def test_suggested_default_partner_bank_inbound_payment(self):
        ...
        self.bank_journal_2.bank_account_id = (
            self.out_invoice_1.partner_bank_id
        ) = self.comp_bank_account2
        wizard = self.env["account.payment.register"].with_context(**ctx).create({})
        self.assertRecordValues(
            wizard,
            [
    ...
    def test_payment_method_different_type_single_batch_not_grouped(self):
        ...
        self.assertRecordValues(
            payments[3].line_ids.sorted("balance"),
            [
