            ...
            repr(
                [
                    (
                        ...
                        "in",
                        sorted(
                            self.lead_uk.ids + lead_uk_assigned.ids + children_leads.ids
                        ),
                    )
                ]
            ),
            ...
            repr(
                [
                    (
                        ...
                        "in",
                        sorted(
                            children_leads[0:2].ids + children_leads_assigned[0:2].ids
                        ),
                    )
                ]
            ),
            ...
            repr(
                [
                    (
                        ...
                        "in",
                        sorted(
                            children_leads[2:].ids + children_leads_assigned[2:].ids
                        ),
                    )
                ]
            ),
