...
class TestShopVariantExclusion(HttpCaseWithUserDemo, HttpCaseWithUserPortal):
            ...
            [
                {
                    ...
                    "value_ids": [
                        (
                            ...
                            0,
                            [
                                cls.product_attribute_value_1.id,
                                cls.product_attribute_value_2.id,
                            ],
                        )
                    ],
                }
            ...
            [
                {
                    ...
                    "value_ids": [
                        (
                            ...
                            0,
                            [
                                cls.product_attribute_value_3.id,
                                cls.product_attribute_value_4.id,
                            ],
                        )
                    ],
                }
    ...
    def test_admin_shop_variant_exclusion(self):
        ...
        ptav1 = self._get_product_template_attribute_value(
            self.product_attribute_value_1, self.product_template
        )
        ptav2 = self._get_product_template_attribute_value(
            self.product_attribute_value_3, self.product_template
        )
