    ...
    def _populate_factories(self):
        ...
        def generate_dependant(iterator, *args):
            ...
            for dependant_values in dependants_generator:
                ...
                yield {
                    **dependant_values,
                    **values,
                    "__complete": values["__complete"]
                    and dependant_values["__complete"],
                }
        ...
        return [
            ...
            (
                ...
                populate.cartesian(
                    [False]
                    + self.env["test.populate"]._fields["state"].get_values(self.env)
                ),
            ),
...
class TestNoPopulateModel(models.Model):
    ...
    _description = (
        "A model with no populate method and a required field, should not crash"
    )
