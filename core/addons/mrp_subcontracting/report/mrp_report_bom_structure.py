...
class ReportBomStructure(models.AbstractModel):
    ...
    def _find_special_rules(
        ...
        res = super()._find_special_rules(
            product, product_info, parent_bom, parent_product_id
        )
        ...
        if (
            ...
            if route_info and route_info["route_type"] == "subcontract":
                ...
                subloc_product = product.with_context(
                    location=subcontracting_loc.id, warehouse=False
                ).read(["free_qty", "qty_available"])[0]
                ...
                return {
                    "free_qty": product.uom_id._compute_quantity(
                        subloc_product["free_qty"], bom_uom
                    ),
