...
class TestRedirect(HttpCase):
    ...
    def test_02_redirect_308_RequestUID(self):
        ...
        with patch.object(WebsiteHttp, "_get_error_html", _get_error_html):
            ...
            self.assertEqual(
                urlparse(resp.headers.get("Location", "")).path,
            ...
            self.assertEqual(
                ...
                f"{self.base_url()}/test_website/308/xx-{rec_published.id}",
            )
            ...
            self.assertEqual(resp.status_code, 200)
            self.assertEqual(
                resp.url, f"{self.base_url()}/test_website/308/name-{rec_published.id}"
            )
            ...
            self.assertEqual(
                resp.headers.get("Location"),
                f"{self.base_url()}/test_website/308/name-100",
            )
            ...
            self.assertEqual(
                resp.headers.get("Location"),
                f"{self.base_url()}/test_website/308/xx-100",
            )
            ...
            self.assertEqual(
                resp.headers.get("Location"),
                f"{self.base_url()}/test_website/308/name-{rec_unpublished.id}",
            )
            ...
            self.assertEqual(
                resp.headers.get("Location"),
                f"{self.base_url()}/test_website/308/xx-{rec_unpublished.id}",
            )
            ...
            self.assertEqual(
                resp.headers.get("Location"),
                f"{self.base_url()}/test_website/308/seo-name-{rec_published.id}",
            )
