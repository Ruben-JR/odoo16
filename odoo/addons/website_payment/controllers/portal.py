...
class PaymentPortal(payment_portal.PaymentPortal):
    ...
    def donation_pay(self, **kwargs):
        ...
        kwargs["donation_options"] = kwargs.get(
            "donation_options", json_safe.dumps(dict(customAmount="freeAmount"))
        )
    ...
    def get_provider_fees(
        self, provider_ids=None, amount=None, currency_id=None, country_id=None
    ):
