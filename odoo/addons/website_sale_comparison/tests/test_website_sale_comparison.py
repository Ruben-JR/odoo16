...
class TestUi(odoo.tests.HttpCase):
    def setUp(self):
        ...
        self.attribute_line_varieties = self.env[
        ...
        self.attribute_line_vintage = self.env[
            "product.template.attribute.line"
        ].create(
            {
                "product_tmpl_id": self.template_margaux.id,
        ...
        for variant, price in zip(
            self.variants_margaux, [487.32, 394.05, 532.44, 1047.84]
        ):
    ...
    def test_03_category_order(self):
        ...
        prep_categories = (
            self.template_margaux.valid_product_template_attribute_line_ids._prepare_categories_for_display()
        )
        self.assertEqual(
            prep_categories,
            OrderedDict(
                            ...
                            [
                                (
                                    ...
                                    OrderedDict(
                                        [
                                            (
                                                self.template_margaux.product_variant_id,
                                                self.attribute_line_varieties.product_template_value_ids,
                                            )
                                        ]
                                    ),
                                )
                                ...
                                (
                                    ...
                                    OrderedDict(
                                        [
                                            (
                                                self.template_margaux.product_variant_id,
                                                self.attribute_line_vintage.product_template_value_ids[
                                                    0
                                                ],
                                            )
                                        ]
