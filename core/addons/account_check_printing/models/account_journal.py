...
class AccountJournal(models.Model):
    ...
    def _inverse_check_next_number(self):
        for journal in self:
            ...
            if journal.check_sequence_id:
                journal.check_sequence_id.sudo().number_next_actual = int(
    ...
    def _get_journal_dashboard_data_batched(self):
        ...
        self._fill_dashboard_data_count(
            dashboard_data,
            "account.payment",
            "num_checks_to_print",
            [
    ...
    def action_checks_to_print(self):
        payment_method_line = self.outbound_payment_method_line_ids.filtered(
