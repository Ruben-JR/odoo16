...
class TestStockValuationStandard(TestStockValuationCommon):
    ...
    def test_change_standard_price_1(self):
        ...
        self.assertEqual(self.product1.quantity_svl, 5)
        self.assertEqual(
            self.product1.stock_valuation_layer_ids.sorted()[-1].description,
            "Product value manually modified (from 10.0 to 15.0)",
        )
    ...
    def test_currency_precision_and_standard_svl_value(self):
        ...
        try:
            ...
            self._make_in_move(
                product,
                0.5,
                loc_dest=warehouse.lot_stock_id,
                pick_type=warehouse.in_type_id,
            )
            self._make_out_move(
                product,
                0.5,
                loc_src=warehouse.lot_stock_id,
...
class TestStockValuationAVCO(TestStockValuationCommon):
    ...
    def test_change_in_past_decrease_out_1(self):
        ...
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 10
        )
        self.assertEqual(self.product1.value_svl, 150)
        self.assertEqual(self.product1.quantity_svl, 10)
        self.assertEqual(self.product1.standard_price, 15)
    ...
    def test_rereturn_receipt_1(self):
        ...
        self.assertEqual(self.product1.standard_price, 15)
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 1
        )
    ...
    def test_rounding_slv_1(self):
        ...
        self.assertIn(
            "Rounding Adjustment: -0.01", move_out.stock_valuation_layer_ids.description
        )
    ...
    def test_return_delivery_2(self):
        ...
        move1 = self._make_out_move(
            self.product1, 10, create_picking=True, force_assign=True
        )
...
class TestStockValuationFIFO(TestStockValuationCommon):
    ...
    def test_normal_1(self):
        ...
        self.assertEqual(self.product1.quantity_svl, 5)
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 5
        )
    ...
    def test_change_in_past_increase_out_1(self):
        ...
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 15
        )
    ...
    def test_change_in_past_decrease_out_1(self):
        ...
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 35
        )
    ...
    def test_change_in_past_add_ml_out_1(self):
        ...
        self.assertEqual(
            sum(self.product1.stock_valuation_layer_ids.mapped("remaining_qty")), 25
        )
...
class TestStockValuationChangeCostMethod(TestStockValuationCommon):
    def test_standard_to_fifo_1(self):
        ...
        for svl in self.product1.stock_valuation_layer_ids.sorted()[-2:]:
            self.assertEqual(
                svl.description,
                "Costing method change for product category All: from standard to fifo.",
            )
...
class TestStockValuationChangeValuation(TestStockValuationCommon):
    ...
    def test_standard_manual_to_auto_1(self):
        ...
        self.assertEqual(self.product1.quantity_svl, 10)
        self.assertEqual(
            len(self.product1.stock_valuation_layer_ids.mapped("account_move_id")), 0
        )
        ...
        self.assertEqual(
            len(self.product1.stock_valuation_layer_ids.mapped("account_move_id")), 1
        )
        self.assertEqual(len(self.product1.stock_valuation_layer_ids), 3)
        for svl in self.product1.stock_valuation_layer_ids.sorted()[-2:]:
            self.assertEqual(
                svl.description,
                "Valuation method change for product category All: from manual_periodic to real_time.",
            )
    ...
    def test_standard_auto_to_manual_1(self):
        ...
        self.assertEqual(
            len(self.product1.stock_valuation_layer_ids.mapped("account_move_id")), 2
        )
        self.assertEqual(len(self.product1.stock_valuation_layer_ids), 3)
...
class TestAngloSaxonAccounting(AccountTestInvoicingCommon, TestStockValuationCommon):
    ...
    def test_return_delivery_storno(self):
        ...
        valuation_line = out_move.account_move_ids.line_ids.filtered(
            lambda l: l.account_id == self.stock_valuation_account
        )
        stock_out_line = out_move.account_move_ids.line_ids.filtered(
        ...
        valuation_line = return_move.account_move_ids.line_ids.filtered(
            lambda l: l.account_id == self.stock_valuation_account
        )
        stock_out_line = return_move.account_move_ids.line_ids.filtered(
            lambda l: l.account_id == self.stock_output_account
        )
