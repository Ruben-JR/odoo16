...
class TestLifoPrice(ValuationReconciliationTestCommon):
    def test_lifoprice(self):
        ...
        product_form.categ_id.property_stock_account_input_categ_id = self.company_data[
            "default_account_stock_in"
        ]
        product_form.categ_id.property_stock_account_output_categ_id = (
        ...
        purchase_order_lifo1.picking_ids[
            0
        ].move_ids.quantity_done = purchase_order_lifo1.picking_ids[
            0
        ...
        purchase_order_lifo2.picking_ids[
            0
        ].move_ids.quantity_done = purchase_order_lifo2.picking_ids[
            0
        ].move_ids.product_qty
        ...
        self.assertEqual(
            outgoing_lifo_shipment.move_ids.stock_valuation_layer_ids.value,
            -1400.0,
